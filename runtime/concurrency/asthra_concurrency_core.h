...
bool asthra_concurrency_lock_free_stack_push(asthra_concurrency_lock_free_stack_t *stack,
                                             void *data);

void *asthra_concurrency_lock_free_stack_pop(asthra_concurrency_lock_free_stack_t *stack);
