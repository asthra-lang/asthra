...
int main(void) {
    ...
    if (!test_complete_enum_exhaustiveness()) all_tests_passed = false;
    if (!test_incomplete_enum_exhaustiveness()) all_tests_passed = false;
    if (!test_exhaustiveness_with_wildcard()) all_tests_passed = false;
    if (!test_tagged_union_exhaustiveness()) all_tests_passed = false;
    if (!test_nested_enum_exhaustiveness()) all_tests_passed = false;
