...
static bool test_struct_pattern_with_bindings(void) {
    ...
    TEST_ASSERT(strcmp(struct_pattern->data.struct_pattern.struct_name, "Person") == 0, "Expected 'Person' struct name");
    
    // Check field patterns with explicit bindings
    TEST_ASSERT(ast_node_list_size(struct_pattern->data.struct_pattern.field_patterns) == 2, "Expected 2 field patterns");
    
    // Check name: person_name binding
    ASTNode *field1 = ast_node_list_get(struct_pattern->data.struct_pattern.field_patterns, 0);
    TEST_ASSERT(strcmp(field1->data.field_pattern.field_name, "name") == 0, "Expected 'name' field name");
    TEST_ASSERT(field1->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'name'");
    TEST_ASSERT(strcmp(field1->data.field_pattern.binding_name, "person_name") == 0, "Expected 'person_name' binding");
    ...
    TEST_ASSERT(strcmp(field2->data.field_pattern.field_name, "age") == 0, "Expected 'age' field name");
    TEST_ASSERT(field2->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'age'");
    TEST_ASSERT(strcmp(field2->data.field_pattern.binding_name, "person_age") == 0, "Expected 'person_age' binding");
...
static bool test_struct_pattern_with_ignored_fields(void) {
    ...
    ASTNode *field1 = ast_node_list_get(struct_pattern->data.struct_pattern.field_patterns, 0);
    TEST_ASSERT(strcmp(field1->data.field_pattern.field_name, "important") == 0, "Expected 'important' field name");
    TEST_ASSERT(field1->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'important'");
    TEST_ASSERT(strcmp(field1->data.field_pattern.binding_name, "important") == 0, "Expected 'important' binding");
    ...
    ASTNode *field2 = ast_node_list_get(struct_pattern->data.struct_pattern.field_patterns, 1);
    TEST_ASSERT(strcmp(field2->data.field_pattern.field_name, "useless") == 0, "Expected 'useless' field name");
    TEST_ASSERT(field2->data.field_pattern.binding_name == NULL, "Expected no binding for ignored field");
...
static bool test_mixed_binding_patterns(void) {
    ...
    TEST_ASSERT(ast_node_list_size(struct_pattern->data.struct_pattern.field_patterns) == 4, "Expected 4 field patterns");
    
    // Check name (explicit binding)
    ASTNode *field1 = ast_node_list_get(struct_pattern->data.struct_pattern.field_patterns, 0);
    TEST_ASSERT(strcmp(field1->data.field_pattern.field_name, "name") == 0, "Expected 'name' field name");
    TEST_ASSERT(field1->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'name'");
    TEST_ASSERT(strcmp(field1->data.field_pattern.binding_name, "name") == 0, "Expected 'name' binding");
    TEST_ASSERT(!field1->data.field_pattern.is_ignored, "Field 'name' should not be ignored");
    
    // Check value: val (explicit binding)
    ASTNode *field2 = ast_node_list_get(struct_pattern->data.struct_pattern.field_patterns, 1);
    TEST_ASSERT(strcmp(field2->data.field_pattern.field_name, "value") == 0, "Expected 'value' field name");
    TEST_ASSERT(field2->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'value'");
    TEST_ASSERT(strcmp(field2->data.field_pattern.binding_name, "val") == 0, "Expected 'val' binding");
    ...
    TEST_ASSERT(strcmp(field3->data.field_pattern.field_name, "debug") == 0, "Expected 'debug' field name");
    TEST_ASSERT(field3->data.field_pattern.binding_name == NULL, "Expected no binding for ignored field");
    ...
    TEST_ASSERT(strcmp(field4->data.field_pattern.field_name, "timestamp") == 0, "Expected 'timestamp' field name");
    TEST_ASSERT(field4->data.field_pattern.binding_name != NULL, "Expected explicit binding for 'timestamp'");
    TEST_ASSERT(strcmp(field4->data.field_pattern.binding_name, "timestamp") == 0, "Expected 'timestamp' binding");
