...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_register_coalescing", __FILE__, __LINE__, "Test basic register coalescing", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_coalescing_conflicts", __FILE__, __LINE__, "Test coalescing conflict detection", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_move_elimination", __FILE__, __LINE__, "Test move instruction elimination", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_conservative_coalescing", __FILE__, __LINE__, "Test conservative coalescing strategy", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
