...
AsthraTestResult test_complete_spill_workflow(AsthraTestContext* context) {
    ...
    if (!asthra_test_assert_pointer(context, result, "Register allocation with spilling should succeed")) {
    ...
    if (!asthra_test_assert_bool(context, result->num_assigned <= (int)fixture->num_physical_registers,
