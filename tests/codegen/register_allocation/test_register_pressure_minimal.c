...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_pressure_analysis", __FILE__, __LINE__, "Test basic register pressure analysis", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_pressure_hotspots", __FILE__, __LINE__, "Test register pressure hotspot detection", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_pressure_reduction", __FILE__, __LINE__, "Test register pressure reduction strategies", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_spill_decisions", __FILE__, __LINE__, "Test spill decisions based on pressure", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL}
};
