...
static AsthraTestMetadata test_metadata[] = {
    {"test_linear_scan_basic", __FILE__, __LINE__, "Test basic linear scan allocation",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_linear_scan_overlapping", __FILE__, __LINE__,
     "Test linear scan with overlapping lifetimes", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
     NULL},
    {"test_linear_scan_pressure", __FILE__, __LINE__, "Test linear scan under register pressure",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_linear_scan_holes", __FILE__, __LINE__, "Test linear scan with lifetime holes",
