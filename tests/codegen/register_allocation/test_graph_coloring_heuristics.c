...
AsthraTestResult test_simplicial_elimination_ordering(AsthraTestContext* context) {
    ...
    if (!asthra_test_assert_pointer(context, ordering, "Should return a valid elimination ordering")) {
...
AsthraTestResult test_minimum_degree_heuristic(AsthraTestContext* context) {
    ...
    if (!asthra_test_assert_pointer(context, ordering, "Should return a valid minimum degree ordering")) {
        cleanup_graph_coloring_fixture(fixture);
        return ASTHRA_TEST_FAIL;
    }
...
AsthraTestResult test_largest_degree_first_heuristic(AsthraTestContext* context) {
    ...
    int* coloring = register_allocator_graph_coloring_ldf(fixture->allocator, fixture->interference_graph);
    if (!asthra_test_assert_pointer(context, coloring, "LDF coloring should return a valid coloring")) {
        cleanup_graph_coloring_fixture(fixture);
        return ASTHRA_TEST_FAIL;
    }
