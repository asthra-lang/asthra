...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_method_mangling", __FILE__, __LINE__, "Test basic method name mangling", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_complex_method_mangling", __FILE__, __LINE__, "Test complex method name mangling", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multiple_struct_mangling", __FILE__, __LINE__, "Test multiple struct method mangling", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_method_signature_mangling", __FILE__, __LINE__, "Test method signature mangling", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
...
static AsthraTestResult test_method_signature_mangling(AsthraTestContext* context) {
    const char* test_source = 
        ...
        "    fn add_multiple(self, x: i32, y: i32, z: i32) -> Calculator { Calculator { value: self.value + x + y + z } }\n"
        "}";
...
int main(void) {
    AsthraTestFunction tests[] = {
        test_basic_method_mangling,
        test_complex_method_mangling,
        test_multiple_struct_mangling,
        test_method_signature_mangling
    };
