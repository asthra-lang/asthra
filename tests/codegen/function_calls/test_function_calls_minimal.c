...
static AsthraTestMetadata test_metadata[] = {
    {"test_simple_function_call", __FILE__, __LINE__, "Test simple function call generation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_function_call_with_arguments", __FILE__, __LINE__, "Test function call with arguments", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_method_call_generation", __FILE__, __LINE__, "Test method call generation", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_nested_function_calls", __FILE__, __LINE__, "Test nested function calls", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_chained_function_calls", __FILE__, __LINE__, "Test chained function calls", ASTHRA_TEST_SEVERITY_LOW, 5000000000ULL, false, NULL}
};
...
static AsthraTestResult test_function_call_with_arguments(AsthraTestContext* context) {
    const char* test_source = "package test;\n\npub fn function_name(a: int, b: int, c: int) -> void { }\n\npub fn main(none) -> void { let arg1: int = 1; let arg2: int = 2; let arg3: int = 3; function_name(arg1, arg2, arg3); }";
...
static AsthraTestResult test_method_call_generation(AsthraTestContext* context) {
    const char* test_source = "package test;\n\npub struct MyObject { pub field: int }\n\nimpl MyObject { pub fn method_name(self, arg: int) -> void { } }\n\npub fn main(none) -> void { let obj: MyObject = MyObject { field: 0 }; let argument: int = 42; obj.method_name(argument); }";
...
static AsthraTestResult test_nested_function_calls(AsthraTestContext* context) {
    const char* test_source = "package test;\n\npub fn inner_function(v: int) -> int { return v * 2; }\n\npub fn outer_function(x: int) -> void { }\n\npub fn main(none) -> void { let value: int = 21; outer_function(inner_function(value)); }";
...
static AsthraTestResult test_chained_function_calls(AsthraTestContext* context) {
    const char* test_source = "package test;\n\npub struct MyObject { pub value: int }\n\nimpl MyObject { pub fn method1(self) -> MyObject { return self; } pub fn method2(self) -> MyObject { return self; } pub fn method3(self) -> void { } }\n\npub fn main(none) -> void { let obj: MyObject = MyObject { value: 42 }; obj.method1().method2().method3(); }";
