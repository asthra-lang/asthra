...
RUN_TEST_SUITE(struct_methods_tests, RUN_TEST(test_simple_method_call);
               RUN_TEST(test_method_with_arguments); RUN_TEST(test_chained_method_calls);
               RUN_TEST(test_static_method_call); RUN_TEST(test_method_with_complex_args);)
