...
RUN_TEST_SUITE(struct_assignment_tests,
    RUN_TEST(test_simple_struct_assignment);
    RUN_TEST(test_nested_struct_assignment);
    RUN_TEST(test_pointer_struct_assignment);
