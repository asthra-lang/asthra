...
RUN_TEST_SUITE(struct_complex_types_tests, RUN_TEST(test_struct_with_array_field);
               RUN_TEST(test_struct_with_function_pointer);
               RUN_TEST(test_struct_pointer_dereference); RUN_TEST(test_struct_address_operations);
