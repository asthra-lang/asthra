...
DEFINE_TEST(test_nested_struct_instantiation) {
    ...
    const char *nested_source = "Person { name: \"John\", age: 30, address: Address { street: "
                                "\"Main St\", city: \"Boston\" } }";
...
RUN_TEST_SUITE(struct_instantiation_tests, RUN_TEST(test_simple_struct_instantiation);
               RUN_TEST(test_nested_struct_instantiation);
               RUN_TEST(test_empty_struct_instantiation); RUN_TEST(test_struct_with_expressions);)
