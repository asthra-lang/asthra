...
RUN_TEST_SUITE(struct_generation_suite, RUN_TEST(test_generate_struct_access);
               RUN_TEST(test_generate_struct_assignment);
               RUN_TEST(test_generate_struct_instantiation); RUN_TEST(test_generate_struct_methods);
