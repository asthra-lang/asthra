...
static inline void init_cross_platform_context(CrossPlatformContext *ctx) {
    ...
    PlatformConfig configs[] = {{PLATFORM_X86_64_LINUX, "x86_64-linux", "x86_64", "linux",
                                 CALLING_CONV_SYSTEM_V, 8, 8, true, "att"},
                                {PLATFORM_X86_64_WINDOWS, "x86_64-windows", "x86_64", "windows",
                                 CALLING_CONV_WIN64, 8, 8, true, "intel"},
                                {PLATFORM_X86_64_MACOS, "x86_64-macos", "x86_64", "macos",
                                 CALLING_CONV_SYSTEM_V, 8, 8, true, "att"},
                                {PLATFORM_ARM64_LINUX, "arm64-linux", "arm64", "linux",
                                 CALLING_CONV_AAPCS64, 8, 8, true, "arm"},
                                {PLATFORM_ARM64_MACOS, "arm64-macos", "arm64", "macos",
                                 CALLING_CONV_AAPCS64, 8, 8, true, "arm"},
                                {PLATFORM_ARM64_ANDROID, "arm64-android", "arm64", "android",
                                 CALLING_CONV_AAPCS64, 8, 8, true, "arm"}};
...
static inline const PlatformConfig *get_platform_config(const CrossPlatformContext *ctx,
                                                        PlatformType platform) {
...
static inline void add_platform_instruction(CrossPlatformContext *ctx, const char *mnemonic,
                                            const char *operands, PlatformType platform) {
...
static inline void add_function_call(CrossPlatformContext *ctx, const char *name,
                                     const char *ret_type, int param_count,
                                     const char **param_types, CallingConvention conv) {
