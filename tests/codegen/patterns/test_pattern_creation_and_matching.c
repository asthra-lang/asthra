...
// Test metadata
static AsthraTestMetadata test_metadata[] = {{"test_pattern_creation_and_matching", __FILE__,
                                              __LINE__, "Test pattern creation and basic matching",
                                              ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
                                              NULL}};
