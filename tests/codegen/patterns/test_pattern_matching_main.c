...
static TestCase test_cases[] = {
    {"Pattern Creation and Matching", test_pattern_creation_and_matching, "Basic pattern creation and matching"},
    ...
    {"Match Expression Exhaustiveness", test_match_expression_exhaustiveness, "Exhaustiveness checking"}
};
