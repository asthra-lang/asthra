...
static AsthraTestMetadata test_metadata[] = {
    ...
    {"test_lifetime_management", __FILE__, __LINE__, "Test lifetime analysis and validation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    ...
    {"test_bounds_checking", __FILE__, __LINE__, "Test array bounds and buffer overflow protection", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
...
static MemorySafetyTest memory_safety_tests[] = {
    {
        ...
        "Tests ownership transfer, borrowing validation, and reference counting",
        true
    },
    {
        "Lifetime Management", 
        test_lifetime_management,
        "Tests scope-based lifetime analysis and automatic cleanup",
        true
    },
    {
        "Memory Leak Detection",
        test_memory_leak_detection,
        "Tests leak prevention and statistics tracking",
        false
    },
    {
        "Bounds Checking",
        test_bounds_checking,
        "Tests array bounds validation and buffer overflow protection",
        false
    }
};
...
static void print_test_summary(int passed, int total, int critical_passed, int critical_total) {
    ...
    printf("Critical Tests: %d/%d (%.1f%%)\n", critical_passed, critical_total, (critical_passed * 100.0) / critical_total);
