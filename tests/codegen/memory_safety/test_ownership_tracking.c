...
AsthraTestResult test_ownership_tracking(AsthraTestContext *context) {
    ...
    BorrowReference *shared_borrow1 =
        create_borrow(&ctx, ptr2, OWNERSHIP_BORROWED_SHARED, lifetime->lifetime_id, "shared1");
    BorrowReference *shared_borrow2 =
        create_borrow(&ctx, ptr2, OWNERSHIP_BORROWED_SHARED, lifetime->lifetime_id, "shared2");
    ...
    BorrowReference *mutable_borrow =
        create_borrow(&ctx, ptr2, OWNERSHIP_BORROWED_MUTABLE, lifetime->lifetime_id, "mutable");
    ...
    mutable_borrow = create_borrow(&ctx, ptr2, OWNERSHIP_BORROWED_MUTABLE, lifetime->lifetime_id,
                                   "mutable_after");
