...
AsthraTestResult test_lifetime_management(AsthraTestContext* context) {
    ...
    BorrowReference* outer_borrow = create_borrow(&ctx, outer_ptr, OWNERSHIP_BORROWED_SHARED, outer_lifetime->lifetime_id, "outer_borrow");
    BorrowReference* inner_borrow = create_borrow(&ctx, outer_ptr, OWNERSHIP_BORROWED_SHARED, inner_lifetime->lifetime_id, "inner_borrow");
    ...
    BorrowReference* short_lived = create_borrow(&ctx, inner_ptr, OWNERSHIP_BORROWED_MUTABLE, new_inner->lifetime_id, "short");
