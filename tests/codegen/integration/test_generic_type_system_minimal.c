...
static AsthraTestMetadata test_metadata[] = {
    {"test_generic_type_creation", __FILE__, __LINE__,
     "Test creating generic types with parameters", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
     NULL},
    {"test_type_parameter_constraints", __FILE__, __LINE__,
     "Test type parameter constraints and validation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL,
     false, NULL},
    {"test_generic_instantiation", __FILE__, __LINE__,
     "Test instantiating generic types with concrete types", ASTHRA_TEST_SEVERITY_HIGH,
     5000000000ULL, false, NULL},
    {"test_complex_generic_scenarios", __FILE__, __LINE__, "Test complex generic type scenarios",
...
static void add_type_parameter(GenericType *generic, const char *param_name,
                               TypeParameterKind kind) {
...
static bool instantiate_generic_type(GenericType *generic, const char **concrete_types,
                                     int type_count) {
...
static AsthraTestResult test_complex_generic_scenarios(AsthraTestContext *context) {
    ...
    if (ref_type->parameter_count != 2 || ref_type->parameters[0].kind != TYPE_PARAM_LIFETIME ||
