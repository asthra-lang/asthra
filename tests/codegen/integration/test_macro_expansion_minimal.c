...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_macro_definition", __FILE__, __LINE__, "Test basic macro definition and structure",
     ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_function_like_macros", __FILE__, __LINE__, "Test function-like macro patterns",
     ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_macro_expansion_engine", __FILE__, __LINE__, "Test macro expansion with substitution",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_complex_macro_scenarios", __FILE__, __LINE__,
     "Test complex macro scenarios and edge cases", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL,
     false, NULL}};
...
static MacroDefinition *define_macro(MacroSystemContext *ctx, const char *name,
                                     bool is_function_like) {
...
static void add_macro_pattern_token(MacroDefinition *macro, MacroTokenKind kind,
                                    const char *value) {
...
static void add_macro_expansion_token(MacroDefinition *macro, MacroTokenKind kind,
                                      const char *value) {
...
static MacroExpansion *expand_macro(MacroSystemContext *ctx, const char *macro_name,
                                    MacroToken *args, int arg_count) {
...
static AsthraTestResult test_macro_expansion_engine(AsthraTestContext *context) {
    ...
    MacroToken args[] = {{MACRO_TOKEN_LITERAL, "\"Hello, world!\"", false, 0}};
...
static AsthraTestResult test_complex_macro_scenarios(AsthraTestContext *context) {
    ...
    MacroToken dummy_args[] = {{MACRO_TOKEN_LITERAL, "test", false, 0}};
    ...
    if (macro1->macro_id == macro2->macro_id || macro2->macro_id == macro3->macro_id ||
    ...
    MacroToken complex_args[] = {{MACRO_TOKEN_IDENTIFIER, "x + 1", false, 0},
