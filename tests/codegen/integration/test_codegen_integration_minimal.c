...
static AsthraTestMetadata test_metadata[] = {
    {"test_end_to_end_codegen", __FILE__, __LINE__, "Test end-to-end code generation",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multi_function_codegen", __FILE__, __LINE__, "Test multi-function code generation",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_program_integration", __FILE__, __LINE__, "Test complete program integration",
...
static AsthraTestResult test_end_to_end_codegen(AsthraTestContext *context) {
    const char *test_source = "fn main(void) {\n"
                              "    let x = 42;\n"
                              "    let y = calculate(x);\n"
                              "    return y;\n"
                              "}\n"
...
// Main test runner
int main(void) {
    AsthraTestFunction tests[] = {test_end_to_end_codegen, test_multi_function_codegen,
