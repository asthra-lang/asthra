...
static AsthraTestMetadata test_metadata[] = {
    {"test_trait_definition", __FILE__, __LINE__, "Test basic trait definition with methods",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_trait_inheritance", __FILE__, __LINE__, "Test trait inheritance and super traits",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_trait_implementation", __FILE__, __LINE__, "Test implementing traits for types",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_blanket_implementations", __FILE__, __LINE__, "Test blanket trait implementations",
...
static void add_trait_method(TraitDefinition *trait, const char *method_name, TraitMethodKind kind,
                             const char *signature) {
...
static TraitImplementation *implement_trait(TraitSystemContext *ctx, const char *trait_name,
                                            const char *type_name) {
...
static void add_impl_method(TraitImplementation *impl, const char *method_name,
                            const char *signature) {
...
static AsthraTestResult test_trait_definition(AsthraTestContext *context) {
    ...
    add_trait_method(display_trait, "fmt", TRAIT_METHOD_REQUIRED,
                     "&self, f: &mut Formatter) -> Result");
...
static AsthraTestResult test_trait_inheritance(AsthraTestContext *context) {
    ...
    add_trait_method(debug_trait, "debug_fmt", TRAIT_METHOD_REQUIRED,
                     "&self, f: &mut Formatter) -> Result");
    ...
    add_trait_method(advanced_trait, "advanced_operation", TRAIT_METHOD_REQUIRED,
                     "&self -> Result<(), Error>");
...
static AsthraTestResult test_trait_implementation(AsthraTestContext *context) {
    ...
    add_impl_method(display_impl, "fmt",
                    "&self, f: &mut Formatter) -> Result { write!(f, \"MyStruct\") }");
