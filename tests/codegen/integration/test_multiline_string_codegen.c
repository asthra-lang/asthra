...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_multiline_string_codegen", __FILE__, __LINE__, "Test basic multi-line string code generation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multiline_string_with_quotes", __FILE__, __LINE__, "Test multi-line string with embedded quotes", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multiline_string_with_special_chars", __FILE__, __LINE__, "Test multi-line string with special characters", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multiline_string_with_unicode", __FILE__, __LINE__, "Test multi-line string with unicode", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
...
static AsthraTestResult test_multiline_string_special_chars_codegen(AsthraTestContext *context) {
    ...
    if (!result) {
        return asthra_test_fail(context, "Failed to generate code for string with special characters");
    }
