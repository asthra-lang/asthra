...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_assembly_generation", __FILE__, __LINE__, "Test basic assembly generation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_function_assembly", __FILE__, __LINE__, "Test function assembly generation", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_data_section_assembly", __FILE__, __LINE__, "Test data section assembly", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
...
int main(void) {
    AsthraTestFunction tests[] = {
        test_basic_assembly_generation,
        test_function_assembly,
