...
static AsthraTestMetadata test_metadata[] = {
    {"test_basic_instruction_selection", __FILE__, __LINE__, "Test basic instruction selection",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_arithmetic_instruction_patterns", __FILE__, __LINE__,
     "Test arithmetic instruction patterns", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_memory_instruction_selection", __FILE__, __LINE__, "Test memory instruction selection",
     ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_control_flow_instructions", __FILE__, __LINE__,
     "Test control flow instruction selection", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
     NULL}};
...
static AsthraTestResult test_basic_instruction_selection(AsthraTestContext *context) {
    const char *test_source = "fn test_basic(void) {\n"
                              "    let x = 5;\n"
                              "    let y = x + 3;\n"
                              "    return y;\n"
                              "}";
...
static AsthraTestResult test_arithmetic_instruction_patterns(AsthraTestContext *context) {
    const char *test_source = "fn test_arithmetic(void) {\n"
                              "    let a = 10;\n"
...
static AsthraTestResult test_memory_instruction_selection(AsthraTestContext *context) {
    const char *test_source = "fn test_memory(void) {\n"
                              "    let arr = [1, 2, 3, 4];\n"
...
static AsthraTestResult test_control_flow_instructions(AsthraTestContext *context) {
    const char *test_source = "fn test_control_flow(x: i32) -> i32 {\n"
...
int main(void) {
    AsthraTestFunction tests[] = {
        test_basic_instruction_selection, test_arithmetic_instruction_patterns,
        test_memory_instruction_selection, test_control_flow_instructions};
