 ...
 */
static ASTNode *create_test_generic_struct_decl(const char *struct_name, const char **type_params,
                                                size_t param_count) {
...
static bool test_generic_struct_registration(void) {
    ...
    TEST_ASSERT(registry->struct_count == 1,
                "Registry still has one struct after duplicate registration");
...
static bool test_generic_struct_instantiation(void) {
    ...
    TEST_ASSERT(info->instantiation_count == 1,
                "Still has only one instantiation (deduplication works)");
...
static bool test_multiple_type_parameters(void) {
    ...
    bool registered =
        code_generator_register_generic_struct(generator, "Pair", struct_decl, struct_type);
    ...
    TEST_ASSERT(strcmp(inst->concrete_name, "Pair_i32_string") == 0,
                "Concrete name is correct for multiple params");
    ...
    bool instantiated2 =
        code_generate_generic_struct_instantiation(generator, "Pair", type_args2, 2);
...
static bool test_c_code_generation(void) {
    ...
    bool generated =
        code_generate_all_generic_instantiations(generator, output_buffer, sizeof(output_buffer));
    TEST_ASSERT(generated, "C code generation succeeds");

    // Verify generated code contains expected elements
    TEST_ASSERT(strstr(output_buffer, "Vec_i32") != NULL,
                "Generated code contains concrete struct name");
    TEST_ASSERT(strstr(output_buffer, "typedef struct") != NULL,
                "Generated code contains struct definition");
    TEST_ASSERT(strstr(output_buffer, "// Generated from generic struct Vec") != NULL,
...
static bool test_error_handling(void) {
    ...
    bool failed_inst =
        code_generate_generic_struct_instantiation(generator, "NonExistent", type_args, 1);
    ...
    bool failed_count =
        code_generate_generic_struct_instantiation(generator, "TestStruct", type_args_too_many, 2);
    ...
    bool failed_null_args =
        code_generate_generic_struct_instantiation(generator, "TestStruct", NULL, 1);
...
static bool test_statistics_and_debugging(void) {
    ...
    GenericStructInfo *vec_info =
        generic_registry_lookup_struct(generator->generic_registry, "Vec");
    ...
    // Verify statistics
    TEST_ASSERT(atomic_load(&generator->generic_registry->total_instantiations) == 3,
                "Total instantiations statistic");
    TEST_ASSERT(atomic_load(&generator->generic_registry->concrete_structs_generated) == 3,
                "Concrete structs generated statistic");
