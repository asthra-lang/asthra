...
static AsthraTestResult test_option_type_declaration(AsthraTestContext* context) {
    ...
    if (!asthra_test_assert_bool_eq(context, 
                                   compile_and_verify_option_code(source, true), 
                                   true,
...
AsthraTestSuite* create_option_codegen_test_suite(void) {
    AsthraTestSuite* suite = asthra_test_suite_create("Option Codegen Tests", 
                                                     "Option<T> code generation testing");
    ...
    asthra_test_suite_add_test(suite, "test_option_return_type_codegen", 
                              "Option as return type codegen", 
                              test_option_return_type_codegen);
    
    asthra_test_suite_add_test(suite, "test_nested_option_codegen", 
                              "Nested Option types codegen", 
                              test_nested_option_codegen);
    
    asthra_test_suite_add_test(suite, "test_option_struct_field_codegen", 
                              "Option in struct field codegen", 
                              test_option_struct_field_codegen);
