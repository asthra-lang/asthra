...
int main(void) {
    ...
    AsthraTestSuiteConfig config = create_statement_test_suite_config(
        "Simple Program Generation Tests",
        "Test code generation for complete simple programs",
        stats
    );
    ...
    AsthraTestMetadata metadata[] = {
        {"test_generate_minimal_program", __FILE__, __LINE__, "test_generate_minimal_program", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_program_with_variables", __FILE__, __LINE__, "test_generate_program_with_variables", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_program_with_control_flow", __FILE__, __LINE__, "test_generate_program_with_control_flow", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL}
    };
