...
AsthraTestResult test_generate_simple_assignments(AsthraTestContext *context) {
    ...
    AsthraTestResult result =
        test_statement_generation_pattern(context, fixture, source, "simple assignment");
...
AsthraTestResult test_generate_compound_assignments(AsthraTestContext *context) {
    ...
    AsthraTestResult result =
        test_statement_generation_pattern(context, fixture, source, "compound assignment");
...
AsthraTestResult test_generate_multiplication_assignment(AsthraTestContext *context) {
    ...
    AsthraTestResult result =
        test_statement_generation_pattern(context, fixture, source, "multiplication assignment");
...
AsthraTestResult test_generate_division_assignment(AsthraTestContext *context) {
    ...
    AsthraTestResult result =
        test_statement_generation_pattern(context, fixture, source, "division assignment");
...
AsthraTestResult test_generate_all_compound_assignments(AsthraTestContext *context) {
    ...
    for (size_t i = 0; i < test_count; i++) {
        AsthraTestResult result = test_statement_generation_pattern(context, fixture, test_cases[i],
                                                                    "compound assignment");
...
AsthraTestResult test_generate_complex_assignments(AsthraTestContext *context) {
    ...
    const char *test_cases[] = {"result = a + b * c;", "value = func(x, y, z);",
...
int main(void) {
    ...
    AsthraTestMetadata metadata[] = {{"test_generate_simple_assignments", __FILE__, __LINE__,
                                      "test_generate_simple_assignments", ASTHRA_TEST_SEVERITY_HIGH,
