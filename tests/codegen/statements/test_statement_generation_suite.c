...
int main(void) {
    ...
    AsthraTestSuiteConfig config = create_statement_test_suite_config(
        ...
        "Comprehensive test suite for all statement generation including declarations, "
        "assignments, control flow, function calls, and returns",
        stats);
    ...
    AsthraTestFunction tests[] = {
        ...
        // Assignment statement tests
        test_generate_simple_assignments, test_generate_compound_assignments,
        test_generate_multiplication_assignment, test_generate_division_assignment,
        test_generate_all_compound_assignments, test_generate_complex_assignments,

        // Control flow statement tests
        test_generate_if_statements, test_generate_if_else_statements, test_generate_while_loops,
        test_generate_for_loops, test_generate_break_statements, test_generate_continue_statements,
        test_generate_nested_control_flow, test_generate_complex_conditionals,

        // Function call statement tests
        test_generate_simple_function_calls, test_generate_method_calls,
        test_generate_chained_method_calls, test_generate_function_calls_with_args,
        test_generate_contextual_function_calls, test_generate_complex_function_calls,
    ...
    AsthraTestMetadata metadata[] = {
        ...
        {"test_generate_variable_declarations", __FILE__, __LINE__,
         "test_generate_variable_declarations", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_variable_with_expression", __FILE__, __LINE__,
         "test_generate_variable_with_expression", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_constant_declarations", __FILE__, __LINE__,
         "test_generate_constant_declarations", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_uninitialized_declarations", __FILE__, __LINE__,
         "test_generate_uninitialized_declarations", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL,
         false, NULL},
        {"test_generate_typed_declarations", __FILE__, __LINE__, "test_generate_typed_declarations",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},

        // Assignment statement tests metadata
        {"test_generate_simple_assignments", __FILE__, __LINE__, "test_generate_simple_assignments",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_compound_assignments", __FILE__, __LINE__,
         "test_generate_compound_assignments", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_multiplication_assignment", __FILE__, __LINE__,
         "test_generate_multiplication_assignment", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_division_assignment", __FILE__, __LINE__,
         "test_generate_division_assignment", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_all_compound_assignments", __FILE__, __LINE__,
         "test_generate_all_compound_assignments", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_complex_assignments", __FILE__, __LINE__,
         "test_generate_complex_assignments", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},

        // Control flow statement tests metadata
        {"test_generate_if_statements", __FILE__, __LINE__, "test_generate_if_statements",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_if_else_statements", __FILE__, __LINE__, "test_generate_if_else_statements",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_while_loops", __FILE__, __LINE__, "test_generate_while_loops",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_for_loops", __FILE__, __LINE__, "test_generate_for_loops",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_break_statements", __FILE__, __LINE__, "test_generate_break_statements",
         ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
        {"test_generate_continue_statements", __FILE__, __LINE__,
         "test_generate_continue_statements", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_generate_nested_control_flow", __FILE__, __LINE__,
         "test_generate_nested_control_flow", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_complex_conditionals", __FILE__, __LINE__,
         "test_generate_complex_conditionals", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},

        // Function call statement tests metadata
        {"test_generate_simple_function_calls", __FILE__, __LINE__,
         "test_generate_simple_function_calls", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_method_calls", __FILE__, __LINE__, "test_generate_method_calls",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_generate_chained_method_calls", __FILE__, __LINE__,
         "test_generate_chained_method_calls", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_generate_function_calls_with_args", __FILE__, __LINE__,
         "test_generate_function_calls_with_args", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_contextual_function_calls", __FILE__, __LINE__,
         "test_generate_contextual_function_calls", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL,
         false, NULL},
        {"test_generate_complex_function_calls", __FILE__, __LINE__,
         "test_generate_complex_function_calls", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_generate_void_function_calls", __FILE__, __LINE__,
         "test_generate_void_function_calls", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},

        // Return statement tests metadata
        {"test_generate_simple_return_statements", __FILE__, __LINE__,
         "test_generate_simple_return_statements", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_return_with_expression", __FILE__, __LINE__,
         "test_generate_return_with_expression", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_empty_return_statements", __FILE__, __LINE__,
         "test_generate_empty_return_statements", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false,
         NULL},
        {"test_generate_return_with_various_expressions", __FILE__, __LINE__,
         "test_generate_return_with_various_expressions", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL,
         false, NULL},
        {"test_generate_return_with_arithmetic", __FILE__, __LINE__,
         "test_generate_return_with_arithmetic", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_generate_return_with_logical", __FILE__, __LINE__,
         "test_generate_return_with_logical", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_generate_return_with_complex_expressions", __FILE__, __LINE__,
         "test_generate_return_with_complex_expressions", ASTHRA_TEST_SEVERITY_MEDIUM,
