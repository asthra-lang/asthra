 ...
 *
 * Test code generation for function call statements including simple calls, method calls, and
 * chained calls
 */
...
int main(void) {
    ...
    AsthraTestSuiteConfig config = create_statement_test_suite_config(
        "Function Call Statement Generation Tests",
        "Test code generation for function call statements including simple calls, method calls, "
        "and chained calls",
        stats);
    ...
    AsthraTestMetadata metadata[] = {{"test_generate_simple_function_calls", __FILE__, __LINE__,
                                      "test_generate_simple_function_calls",
                                      ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
                                     {"test_generate_method_calls", __FILE__, __LINE__,
                                      "test_generate_method_calls", ASTHRA_TEST_SEVERITY_HIGH,
