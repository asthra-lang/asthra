...
RUN_TEST_SUITE(expression_generation_suite,
    RUN_TEST(test_generate_arithmetic_expressions);
    RUN_TEST(test_generate_logical_expressions);
    RUN_TEST(test_generate_comparison_expressions);
    RUN_TEST(test_generate_call_expressions);
    RUN_TEST(test_generate_unary_expressions);
