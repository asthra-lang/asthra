...
bool test_peephole_optimization(void) {
    ...
    Instruction instructions[4] = {
        ...
        {.opcode = OP_MOV, .dst_reg = 1, .operand1 = {.type = OPERAND_REGISTER, .reg = 0}}, // Redundant
        {.opcode = OP_ADD, .dst_reg = 2, .operand1 = {.type = OPERAND_REGISTER, .reg = 2}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 0}}, // Add 0
