...
bool test_common_subexpression_elimination(void) {
    ...
    Instruction instructions[4] = {
        {.opcode = OP_ADD, .dst_reg = 0, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 5}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 3}},
        {.opcode = OP_MOV, .dst_reg = 1, .operand1 = {.type = OPERAND_REGISTER, .reg = 0}},
        {.opcode = OP_ADD, .dst_reg = 2, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 5}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 3}}, // Same as first
