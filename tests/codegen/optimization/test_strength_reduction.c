...
bool test_strength_reduction(void) {
    ...
    Instruction instructions[3] = {
        {.opcode = OP_MUL, .dst_reg = 0, .operand1 = {.type = OPERAND_REGISTER, .reg = 1}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 2}},
        {.opcode = OP_MUL, .dst_reg = 1, .operand1 = {.type = OPERAND_REGISTER, .reg = 2}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 4}},
        {.opcode = OP_MUL, .dst_reg = 2, .operand1 = {.type = OPERAND_REGISTER, .reg = 3}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 8}}
    };
