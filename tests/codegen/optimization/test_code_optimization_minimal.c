...
static AsthraTestMetadata test_metadata[] = {
    {"test_constant_folding", __FILE__, __LINE__, "Test constant folding optimization", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_dead_code_elimination", __FILE__, __LINE__, "Test dead code elimination", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_loop_optimization", __FILE__, __LINE__, "Test loop optimization techniques", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
