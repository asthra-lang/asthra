...
DEFINE_TEST(test_reaching_definitions) {
    ...
    Instruction instructions[8] = {
        {.opcode = OP_MOV, .dst_reg = 0, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 10}, .is_definition = true},
        {.opcode = OP_MOV, .dst_reg = 1, .operand1 = {.type = OPERAND_REGISTER, .reg = 0}, .is_use = true},
        {.opcode = OP_CMP, .operand1 = {.type = OPERAND_REGISTER, .reg = 1}, .operand2 = {.type = OPERAND_IMMEDIATE, .value = 5}, .is_use = true},
        {.opcode = OP_JGT, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 6}},
        {.opcode = OP_MOV, .dst_reg = 0, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 20}, .is_definition = true},
        {.opcode = OP_JMP, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 7}},
        {.opcode = OP_MOV, .dst_reg = 0, .operand1 = {.type = OPERAND_IMMEDIATE, .value = 30}, .is_definition = true},
        {.opcode = OP_ADD, .dst_reg = 2, .operand1 = {.type = OPERAND_REGISTER, .reg = 0}, .operand2 = {.type = OPERAND_REGISTER, .reg = 1}, .is_use = true}
    };
