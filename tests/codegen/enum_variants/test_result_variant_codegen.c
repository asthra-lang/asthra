...
static void test_result_ok_codegen(void) {
    ...
    if (assembly) {
        ...
        bool has_value_42 = strstr(assembly, "42") != NULL ||
                           strstr(assembly, "$42") != NULL ||
                           strstr(assembly, "#42") != NULL;
        
        bool has_target_register = strstr(assembly, "rax") != NULL ||
                                  strstr(assembly, "%rax") != NULL;
...
static void test_result_err_codegen(void) {
    ...
    if (assembly) {
        ...
        bool has_error_string = strstr(assembly, "error") != NULL ||
                               strstr(assembly, "string") != NULL;
        
        bool has_target_register = strstr(assembly, "rcx") != NULL ||
                                  strstr(assembly, "%rcx") != NULL;
