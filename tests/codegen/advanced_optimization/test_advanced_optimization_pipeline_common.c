...
AsthraTestMetadata test_metadata[] = {
    {"test_optimization_pipeline_creation", __FILE__, __LINE__, "Test optimization pipeline setup", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_multi_pass_optimization", __FILE__, __LINE__, "Test multiple optimization passes", ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_optimization_effectiveness", __FILE__, __LINE__, "Test optimization effectiveness metrics", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_optimization_validation", __FILE__, __LINE__, "Test optimization correctness validation", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}
};
...
void init_optimization_context(MinimalOptimizationContext* ctx) {
    ...
    for (int i = 0; i < OPT_COUNT; i++) {
        ctx->passes[i] = (MinimalOptimizationPass){
            .type = i,
            .name = pass_names[i],
            .enabled = true,
            .priority = i + 1,
