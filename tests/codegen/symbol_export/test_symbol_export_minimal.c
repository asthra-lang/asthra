...
static AsthraTestMetadata test_metadata[] = {
    {"test_public_symbol_export", __FILE__, __LINE__, "Test public symbol export generation",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_private_symbol_export", __FILE__, __LINE__, "Test private symbol export handling",
     ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
    {"test_mixed_visibility_export", __FILE__, __LINE__, "Test mixed visibility symbol export",
     ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
    {"test_export_name_mangling", __FILE__, __LINE__, "Test export symbol name mangling",
     ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}};
...
static AsthraTestResult test_public_symbol_export(AsthraTestContext *context) {
    const char *test_source = "pub fn public_function() -> i32 { return 42; }\n"
...
static AsthraTestResult test_private_symbol_export(AsthraTestContext *context) {
    const char *test_source = "fn private_function() -> i32 { return 24; }\n"
...
static AsthraTestResult test_mixed_visibility_export(AsthraTestContext *context) {
    const char *test_source = "pub fn public_api() -> i32 { return helper(); }\n"
...
static AsthraTestResult test_export_name_mangling(AsthraTestContext *context) {
    const char *test_source = "pub mod math {\n"
...
// Main test runner
int main(void) {
    AsthraTestFunction tests[] = {test_public_symbol_export, test_private_symbol_export,
                                  test_mixed_visibility_export, test_export_name_mangling};
