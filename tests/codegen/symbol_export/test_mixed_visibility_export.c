...
AsthraTestResult test_mixed_visibility_export(AsthraTestContext* context) {
    ...
    bool has_private_helper_export = has_symbol_export(result.output, "Point_instance_private_helper");
...
AsthraTestResult test_complex_mixed_visibility(AsthraTestContext* context) {
    const char* source = 
        "pub struct Database { pub name: string; connection_string: string; }\n"
        "impl Database {\n"
    ...
    bool has_validate_export = has_symbol_export(result.output, "Database_instance_validate_connection");
    bool has_cleanup_export = has_symbol_export(result.output, "Database_instance_internal_cleanup");
...
AsthraTestResult run_mixed_visibility_export_tests(void) {
    ...
    AsthraTestMetadata base_metadata = {
        .name = "Mixed Visibility Export Tests",
        .file = __FILE__,
        .line = __LINE__,
        .function = __func__,
