...
typedef enum {
    OPTIMIZATION_LEVEL_O0, OPTIMIZATION_LEVEL_O1, OPTIMIZATION_LEVEL_O2, OPTIMIZATION_LEVEL_O3
} OptimizationLevel;

typedef enum {
    OP_MOV, OP_ADD, OP_SUB, OP_MUL, OP_DIV, OP_CMP, OP_JMP, OP_JGT, OP_JGE, OP_RET, OP_NOP
} OpCode;
