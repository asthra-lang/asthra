...
static LLVMBackendData *create_test_backend() {
    ...
    // Create a test function that returns i32 for pattern matching tests
    LLVMTypeRef fn_type = LLVMFunctionType(data->i32_type, NULL, 0, false);
...
static bool test_match_no_expression() {
    ...
    arms[0] = create_match_arm(create_integer_literal(42),
                               create_return_stmt(create_integer_literal(1)), NULL);
...
static bool test_simple_match_statement() {
    ...
    arms[0] = create_match_arm(create_integer_literal(1),
                               create_return_stmt(create_integer_literal(10)), NULL);
    arms[1] = create_match_arm(create_integer_literal(2),
                               create_return_stmt(create_integer_literal(20)), NULL);
    ...
    // Add a default return to ensure the function has a terminator
...
static bool test_identifier_pattern() {
    ...
    ASTNode **arms = malloc(sizeof(ASTNode *) * 1);
    arms[0] =
        create_match_arm(create_identifier("x"), create_return_stmt(create_identifier("x")), NULL);
    ASTNodeList *arm_list = create_node_list(arms, 1);
...
static bool test_match_with_guard() {
    ...
    ASTNode **arms = malloc(sizeof(ASTNode *) * 1);
    arms[0] =
        create_match_arm(create_identifier("x"), create_return_stmt(create_identifier("x")), guard);
    ASTNodeList *arm_list = create_node_list(arms, 1);
...
static bool test_multiple_match_arms() {
    ...
    arms[1] = create_match_arm(create_integer_literal(2),
                               create_return_stmt(create_integer_literal(20)), NULL);
    arms[2] = create_match_arm(create_identifier("_"),
                               create_return_stmt(create_integer_literal(0)), NULL);
