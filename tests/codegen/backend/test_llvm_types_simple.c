...
static int test_type_cache_init(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->i32_type), LLVMIntegerTypeKind, "i32 cache should be integer");
    TEST_ASSERT_EQ(LLVMGetIntTypeWidth(g_backend_data->i32_type), 32, "i32 cache should be 32 bits");
    
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->bool_type), LLVMIntegerTypeKind, "bool cache should be integer");
    TEST_ASSERT_EQ(LLVMGetIntTypeWidth(g_backend_data->bool_type), 1, "bool cache should be 1 bit");
    
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->f32_type), LLVMFloatTypeKind, "f32 cache should be float");
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->f64_type), LLVMDoubleTypeKind, "f64 cache should be double");
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->void_type), LLVMVoidTypeKind, "void cache should be void");
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->ptr_type), LLVMPointerTypeKind, "ptr cache should be pointer");
    TEST_ASSERT_EQ(LLVMGetTypeKind(g_backend_data->unit_type), LLVMStructTypeKind, "unit cache should be struct");
...
static int test_primitive_type_conversion(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_i32), LLVMIntegerTypeKind, "i32 should convert to integer type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_i64), LLVMIntegerTypeKind, "i64 should convert to integer type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_bool), LLVMIntegerTypeKind, "bool should convert to integer type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_f32), LLVMFloatTypeKind, "f32 should convert to float type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_f64), LLVMDoubleTypeKind, "f64 should convert to double type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_void), LLVMVoidTypeKind, "void should convert to void type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_never), LLVMVoidTypeKind, "never should convert to void type");
...
static int test_slice_type_conversion(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_slice), LLVMStructTypeKind, "slice should convert to struct type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(field0), LLVMPointerTypeKind, "slice first field should be pointer");
    
    // Second field should be i64 (length)
    LLVMTypeRef field1 = LLVMStructGetTypeAtIndex(llvm_slice, 1);
    TEST_ASSERT_EQ(LLVMGetTypeKind(field1), LLVMIntegerTypeKind, "slice second field should be integer");
...
static int test_option_type_conversion(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_option), LLVMStructTypeKind, "option should convert to struct type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(field0), LLVMIntegerTypeKind, "option first field should be integer");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(field1), LLVMIntegerTypeKind, "option second field should be integer");
...
static int test_tuple_type_conversion(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_tuple), LLVMStructTypeKind, "tuple should convert to struct type");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(elem_type0), LLVMIntegerTypeKind, "tuple first element should be integer");
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(elem_type1), LLVMDoubleTypeKind, "tuple second element should be double");
...
static int test_unit_type_conversion(void) {
    ...
    TEST_ASSERT_EQ(LLVMGetTypeKind(llvm_unit), LLVMStructTypeKind, "unit should convert to struct type");
