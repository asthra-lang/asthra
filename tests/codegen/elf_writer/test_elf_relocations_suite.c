...
int main(void) {
    ...
    AsthraTestSuiteConfig config = {.name = "ELF Relocation Test Suite",
                                    .description =
                                        "Comprehensive test suite for ELF relocation entry "
                                        "generation, processing, and dynamic linking",
    ...
    AsthraTestFunction tests[] = {test_relocation_entry_generation,
    ...
    AsthraTestMetadata metadata[] = {
        ...
        {"test_relocation_processing", __FILE__, __LINE__, "test_relocation_processing",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_relocation_types", __FILE__, __LINE__, "test_relocation_types",
         ASTHRA_TEST_SEVERITY_HIGH, 5000000000ULL, false, NULL},
        {"test_relocation_section_management", __FILE__, __LINE__,
         "test_relocation_section_management", ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false,
         NULL},
        {"test_dynamic_relocation_support", __FILE__, __LINE__, "test_dynamic_relocation_support",
         ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
        {"test_relocation_validation", __FILE__, __LINE__, "test_relocation_validation",
         ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}};
