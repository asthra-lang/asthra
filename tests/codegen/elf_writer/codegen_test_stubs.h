...
// ELF Writer fixtures are defined in elf_writer_test_common.h
// Removed conflicting declarations - use the ones from elf_writer_test_common.h instead
...
// ELFWriterFixture and setup_elf_writer_fixture are in elf_writer_test_common.h
