...
int main(void) {
    ...
    AsthraTestFunction tests[] = {test_symbol_table_creation,    test_symbol_binding_types,
                                  test_symbol_visibility,        test_dynamic_linking_support,
                                  test_symbol_lookup_resolution, test_symbol_table_ordering};
