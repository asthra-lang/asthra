...
AsthraTestResult test_debug_info_compression(AsthraTestContext *context) {
    ...
    for (int i = 0; i < 100; i++) {
        ...
        ELFVariableDebugInfo var_info = {.name = name,
                                         .type = "int",
...
AsthraTestResult test_debug_info_validation(AsthraTestContext *context) {
    ...
    ELFLineNumberEntry valid_line = {.address = 0x1000, .line = 1, .column = 1, .file_index = 0};
    ...
    ELFLineNumberEntry invalid_line = {.address = 0x1000,
...
int main(void) {
    ...
    AsthraTestFunction tests[] = {test_debug_section_generation, test_debug_info_compression,
                                  test_debug_info_validation};

    AsthraTestMetadata metadata[] = {
        {"test_debug_section_generation", __FILE__, __LINE__, "test_debug_section_generation",
         ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL},
        {"test_debug_info_compression", __FILE__, __LINE__, "test_debug_info_compression",
         ASTHRA_TEST_SEVERITY_LOW, 10000000000ULL, false, NULL},
        {"test_debug_info_validation", __FILE__, __LINE__, "test_debug_info_validation",
         ASTHRA_TEST_SEVERITY_MEDIUM, 5000000000ULL, false, NULL}};
