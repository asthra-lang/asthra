...
void test_integration(void) {
    ...
    success = elf_populate_text_section(test_writer) &&
              elf_populate_ffi_section(test_writer) &&
              elf_populate_gc_section(test_writer) &&
              elf_populate_security_section(test_writer) &&
    ...
    success = elf_validate_structure(test_writer) &&
              elf_validate_c_compatibility(test_writer) &&
