...
static inline bool elf_writer_add_function_debug_info(ELFWriter *writer,
                                                      ELFFunctionDebugInfo *func) {
...
DEFINE_TEST(test_function_debug_info) {
    ...
    ELFFunctionDebugInfo func_info = {.name = "main",
                                      .return_type = "int",
                                      .low_pc = 0x1000,
                                      .high_pc = 0x1100,
...
DEFINE_TEST(test_asthra_specific_debug_features) {
    ...
    ELFTypeDebugInfo option_type = {
        .name = "Option<i32>", .tag = DW_TAG_base_type, .encoding = DW_ATE_signed, .byte_size = 8};
    ...
    ELFTypeDebugInfo result_type = {.name = "Result<i32, String>",
    ...
    ELFTypeDebugInfo slice_type = {
        .name = "&[i32]", .tag = DW_TAG_array_type, .byte_size = 16, .base_type_ref = 1};
...
RUN_TEST_SUITE(elf_debug_dwarf_minimal, RUN_TEST(test_dwarf_compilation_unit);
               RUN_TEST(test_function_debug_info); RUN_TEST(test_type_debug_info);
