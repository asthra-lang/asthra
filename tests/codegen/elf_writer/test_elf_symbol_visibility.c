...
int main(void) {
    ...
    AsthraTestSuiteConfig config = {.name = "ELF Symbol Visibility Test",
    ...
    AsthraTestMetadata metadata[] = {{"test_symbol_visibility", __FILE__, __LINE__,
                                      "test_symbol_visibility", ASTHRA_TEST_SEVERITY_MEDIUM,
