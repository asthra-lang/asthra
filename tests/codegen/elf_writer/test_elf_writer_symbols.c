...
void test_symbol_management(void) {
    ...
    ELFSymbol *symbol = elf_add_symbol(test_writer, "test_symbol", 0x1000, 64,
    ...
    ELFSymbol *pattern_symbol = elf_add_pattern_match_symbol(test_writer, "match_label", 0x3000, NULL);
