...
bool asthra_verify_constant_time(AsthraV12TestContext *ctx, void (*func)(void *), void *data,
                                 size_t iterations);
...
AsthraTestResult test_security_constant_time_verification(AsthraV12TestContext *ctx) {
    ...
    if (!ASTHRA_TEST_ASSERT(&ctx->base, ct_timing_difference < 0.1,
                            "Constant-time timing difference too high: %.3f",
                            ct_timing_difference)) {
        goto cleanup;
    }
...
int main(void) {
    ...
    // Create test context
    AsthraV12TestMetadata metadata = {.base = {.name = "Constant Time Operations",
                                               .file = __FILE__,
                                               .line = __LINE__,
                                               .function = "main",
                                      ...
                                      .feature_description =
                                          "Constant-time operation security tests",
