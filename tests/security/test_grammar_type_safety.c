...
void test_grammar_validation(void) {
    ...
    TEST_ASSERT(result.result == ASTHRA_GRAMMAR_INVALID_SYNTAX, "Unmatched braces should fail validation");
    ...
    TEST_ASSERT(result.result == ASTHRA_GRAMMAR_INVALID_SYNTAX, "Null input should fail validation");
}
