...
void test_ai_annotation_metadata_extraction(void) {
    ...
    AIAnnotationParam hypothesis_param = {.type = ANNOTATION_PARAM_STRING,
...
void test_ai_annotation_type_mapping(void) {
    ...
    const char *annotation_names[] = {
        "ai_confidence", "ai_hypothesis",     "ai_review_needed",   "ai_todo",
        "ai_optimize",   "ai_test_coverage",  "ai_security_review", "ai_pattern",
        "ai_complexity", "ai_refinement_step"};

    AIAnnotationType expected_types[] = {AI_ANNOTATION_CONFIDENCE,    AI_ANNOTATION_HYPOTHESIS,
                                         AI_ANNOTATION_REVIEW_NEEDED, AI_ANNOTATION_TODO,
                                         AI_ANNOTATION_OPTIMIZE,      AI_ANNOTATION_TEST_COVERAGE,
                                         AI_ANNOTATION_SECURITY,      AI_ANNOTATION_PATTERN,
                                         AI_ANNOTATION_COMPLEXITY,    AI_ANNOTATION_REFINEMENT};
