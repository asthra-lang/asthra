...
static AsthraTestResult test_parse_pattern_structs(AsthraTestContext* context) {
    const char* test_source = "match point { Point { x: x_val, y: y_val } => { \"origin\"; }, _ => { \"other\"; } }";
    Parser* parser = create_test_parser(test_source);
...
static AsthraTestResult test_parse_pattern_enums(AsthraTestContext* context) {
    const char* test_source = "match option { Option.Some(value) => { value; }, Option.None => { 0; } }";
    Parser* parser = create_test_parser(test_source);
...
static AsthraTestResult test_parse_array_patterns(AsthraTestContext* context) {
    const char* test_source = "match array { array_value => { process(array_value); }, _ => { default(); } }";
    Parser* parser = create_test_parser(test_source);
...
static AsthraTestResult test_parse_range_patterns(AsthraTestContext* context) {
    // Note: Range patterns are not in the current PEG grammar, so we'll test simple literal patterns
    const char* test_source = "match x { 1 => { \"small\"; }, 11 => { \"medium\"; }, _ => { \"large\"; } }";
    Parser* parser = create_test_parser(test_source);
...
static AsthraTestResult test_parse_complex_nested_patterns(AsthraTestContext* context) {
    ...
    const char* test_source = "match data { Option.Some(value) => { process_adult(value); }, _ => { \"invalid\"; } }";
    Parser* parser = create_test_parser(test_source);
...
AsthraTestSuite* create_grammar_patterns_test_suite(void) {
    AsthraTestSuite* suite = asthra_test_suite_create("Grammar Pattern Tests", 
    ...
    // Pattern matching tests
    asthra_test_suite_add_test(suite, "test_parse_pattern_literals", 
                              "Parse pattern literals", 
                              test_parse_pattern_literals);
    
    asthra_test_suite_add_test(suite, "test_parse_pattern_variables", 
                              "Parse pattern variables", 
                              test_parse_pattern_variables);
    
    asthra_test_suite_add_test(suite, "test_parse_pattern_structs", 
                              "Parse pattern structs", 
                              test_parse_pattern_structs);
    
    asthra_test_suite_add_test(suite, "test_parse_pattern_enums", 
                              "Parse pattern enums", 
                              test_parse_pattern_enums);
    
    asthra_test_suite_add_test(suite, "test_parse_wildcard_patterns", 
                              "Parse wildcard patterns", 
                              test_parse_wildcard_patterns);
    
    asthra_test_suite_add_test(suite, "test_parse_tuple_patterns", 
                              "Parse tuple patterns", 
                              test_parse_tuple_patterns);
    
    asthra_test_suite_add_test(suite, "test_parse_array_patterns", 
                              "Parse array patterns", 
                              test_parse_array_patterns);
    
    asthra_test_suite_add_test(suite, "test_parse_guard_patterns", 
                              "Parse guard patterns", 
                              test_parse_guard_patterns);
    
    asthra_test_suite_add_test(suite, "test_parse_range_patterns", 
                              "Parse range patterns", 
                              test_parse_range_patterns);
    
    asthra_test_suite_add_test(suite, "test_parse_complex_nested_patterns", 
                              "Parse complex nested patterns", 
                              test_parse_complex_nested_patterns);
