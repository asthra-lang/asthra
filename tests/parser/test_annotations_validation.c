...
void test_non_deterministic_required_for_tier2(void) {
    ...
    const char *code_without_annotation = "import \"stdlib/concurrent/channels\";\n"
                                          "\n"
...
void test_non_deterministic_sufficient_for_tier2(void) {
    ...
    const char *code_with_annotation = "import \"stdlib/concurrent/channels\";\n"
                                       "\n"
                                       "#[non_deterministic]\n"
...
void test_tier1_no_annotation_required(void) {
    ...
    const char *tier1_code = "fn tier1_function() -> Result<i32, string> {\n"
