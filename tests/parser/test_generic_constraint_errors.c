...
int main(void) {
    ...
    // Run all tests
    total++;
    if (test_struct_generic_constraint_error())
        passed++;
    total++;
    if (test_enum_generic_constraint_error())
        passed++;
    total++;
    if (test_multiple_constraints_error())
        passed++;
    total++;
    if (test_valid_generic_without_constraint())
        passed++;
