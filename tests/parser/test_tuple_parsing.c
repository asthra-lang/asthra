...
static int test_parse_tuple_element_access(void) {
    ...
    TEST_ASSERT(!parser_had_error(parser), "Parser reported errors when parsing tuple element access");
...
static int test_parse_nested_tuple_access(void) {
    ...
    TEST_ASSERT(!parser_had_error(parser), "Parser reported errors when parsing nested tuple access");
...
static int test_invalid_tuple_element_access(void) {
    ...
    TEST_ASSERT(!parser_had_error(parser), "Parser reported errors for syntactically valid tuple access");
...
int main(void) {
    ...
    // Run all tests
    total++; if (test_parse_simple_tuple_type()) passed++;
    total++; if (test_parse_tuple_literal()) passed++;
    total++; if (test_parse_tuple_pattern()) passed++;
    total++; if (test_single_element_tuple_error()) passed++;
    total++; if (test_parse_tuple_element_access()) passed++;
    total++; if (test_parse_nested_tuple_access()) passed++;
    total++; if (test_invalid_tuple_element_access()) passed++;
