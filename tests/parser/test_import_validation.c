...
int main(void) {
    ...
    // Run all tests
    total++;
    if (test_import_path_early_validation())
        passed++;
    total++;
    if (test_stdlib_path_validation())
        passed++;
    total++;
    if (test_github_path_validation())
        passed++;
    total++;
    if (test_local_path_validation())
        passed++;
    total++;
    if (test_internal_path_validation())
        passed++;
    total++;
