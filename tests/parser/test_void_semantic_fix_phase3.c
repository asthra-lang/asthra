...
int main(void) {
    ...
    // Run all tests
    if (test_function_parameters_none_success())
        passed++;
    if (test_function_parameters_void_error())
        passed++;
    if (test_struct_content_none_success())
        passed++;
    if (test_struct_content_void_error())
        passed++;
    if (test_array_literals_none_success())
        passed++;
    if (test_array_literals_void_error())
        passed++;
    if (test_function_calls_none_success())
        passed++;
    if (test_function_calls_void_error())
        passed++;
    if (test_return_type_void_preserved())
        passed++;
    if (test_pattern_args_none_success())
        passed++;
    if (test_pattern_args_void_error())
        passed++;
