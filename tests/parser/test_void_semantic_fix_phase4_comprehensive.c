...
static bool test_function_parameters_comprehensive(void) {
    ...
    const char* valid_cases[] = {
        ...
        "package test; priv fn private_func(none) -> bool { return true; }",
        NULL
    };
    ...
    if (func_decl) ast_free_node(func_decl);
    cleanup_test_parser(parser);
...
static bool test_struct_content_comprehensive(void) {
    ...
    const char* valid_struct_cases[] = {
        "package test; priv struct EmptyStruct { none }",
        "package test; priv struct PrivateEmpty { none }",
        NULL
    };
    ...
    if (struct_decl) ast_free_node(struct_decl);
    cleanup_test_parser(parser);
...
static bool test_enum_content_comprehensive(void) {
    ...
    const char* valid_enum_cases[] = {
        "package test; priv enum EmptyEnum { none }",
        "package test; priv enum PrivateEmpty { none }",
        NULL
    };
...
static bool test_array_elements_comprehensive(void) {
    ...
    const char* valid_array_cases[] = {
        ...
        "package test; priv fn test(none) -> void { let arr: []bool = [none]; }",
        NULL
    };
...
static bool test_function_call_arguments_comprehensive(void) {
    ...
    const char* valid_call_cases[] = {
        "package test; priv fn helper(none) -> void { } priv fn main(none) -> void { helper(none); }",
        "package test; priv fn test(none) -> i32 { return 42; } priv fn main(none) -> void { let x: i32 = test(none); }",
        NULL
    };
...
static bool test_return_type_preservation_comprehensive(void) {
    ...
    const char* valid_return_cases[] = {
        ...
        "package test; pub extern \"C\" fn exit(code: i32) -> void;",
        NULL
    };
