...
static AsthraTestResult test_parse_primitive_types(AsthraTestContext *context) {
    const char *primitive_types[] = {"i8",  "i16", "i32", "i64",  "u8",   "u16", "u32",
                                     "u64", "f32", "f64", "bool", "char", "void"};
...
static AsthraTestResult test_parse_option_types(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_not_null(context, result,
                                     "Failed to parse Option in variable declaration")) {
        destroy_test_parser(parser);
        return ASTHRA_TEST_FAIL;
    }
...
AsthraTestSuite *create_grammar_types_test_suite(void) {
    AsthraTestSuite *suite = asthra_test_suite_create("Grammar Type Tests", "Type parsing testing");
    ...
    // Type parsing tests
    asthra_test_suite_add_test(suite, "test_parse_primitive_types", "Parse primitive types",
                               test_parse_primitive_types);

    asthra_test_suite_add_test(suite, "test_parse_pointer_types", "Parse pointer types",
                               test_parse_pointer_types);

    asthra_test_suite_add_test(suite, "test_parse_slice_types", "Parse slice types",
                               test_parse_slice_types);

    asthra_test_suite_add_test(suite, "test_parse_result_types", "Parse Result types",
                               test_parse_result_types);

    asthra_test_suite_add_test(suite, "test_parse_option_types", "Parse Option types",
                               test_parse_option_types);

    asthra_test_suite_add_test(suite, "test_parse_struct_types", "Parse struct types",
                               test_parse_struct_types);

    asthra_test_suite_add_test(suite, "test_parse_array_types", "Parse array types",
                               test_parse_array_types);

    asthra_test_suite_add_test(suite, "test_parse_function_types", "Parse function types",
