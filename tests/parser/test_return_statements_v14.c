...
static AsthraTestResult test_grammar_compliance_v14(AsthraTestContext* context) {
    ...
    if (bare_rejected) {
        ...
        if (result1) ast_free_node(result1);
    }
    ...
    if (valid_accepted) {
        ...
        if (result2) ast_free_node(result2);
    }
    ...
    if (unit_accepted) {
        ...
        if (result3) ast_free_node(result3);
    }
...
AsthraTestSuite* create_return_statements_v14_test_suite(void) {
    AsthraTestSuite* suite = asthra_test_suite_create("Return Statement v1.14 Tests", 
    ...
    asthra_test_suite_add_test(suite, "test_unit_return_validation_v14", 
                              "Unit return validation", 
                              test_unit_return_validation_v14);
    
    asthra_test_suite_add_test(suite, "test_return_expression_types_v14", 
    ...
    asthra_test_suite_add_test(suite, "test_grammar_compliance_v14", 
                              ...
                              test_grammar_compliance_v14);
    
    asthra_test_suite_add_test(suite, "test_migration_validation_v14", 
