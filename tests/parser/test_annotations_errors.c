...
void test_invalid_annotation_syntax(void) {
    ...
    const char* invalid_code2 = 
        "#non_deterministic  // Missing brackets\n"
    ...
    const char* invalid_code3 = 
        "#[non-deterministic]  // Invalid hyphen\n"
