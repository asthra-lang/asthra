...
int main(void) {
    ...
    AsthraTestContext pass_context = {
        .metadata = {
            .name = "demo_passing_test",
            .file = __FILE__,
            .line = __LINE__,
    ...
    AsthraTestContext fail_context = {
        .metadata = {
            .name = "demo_failing_test",
            .file = __FILE__,
            .line = __LINE__,
        ...
        .error_message = "This test was designed to fail for demonstration",
        .assertions_in_test = 1
    };
    
    AsthraTestContext skip_context = {
        .metadata = {
            .name = "demo_skipped_test",
            .file = __FILE__,
            .line = __LINE__,
