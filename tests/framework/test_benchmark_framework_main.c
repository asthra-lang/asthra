...
int main(void) {
    ...
    AsthraTestMetadata metadata = {
        .name = "benchmark_framework_tests",
        .file = __FILE__,
        .line = __LINE__,
        .function = "main",
    ...
    AsthraTestResult results[] = {
        test_benchmark_timer_accuracy(context),
        test_benchmark_configuration(context),
        test_simple_benchmark_execution(context),
        test_benchmark_with_setup_teardown(context),
        test_benchmark_suite_execution(context),
        test_statistical_analysis(context)
    };
    ...
    AsthraBenchmarkDefinition demo_benchmarks[] = {
        {
            .config = asthra_benchmark_config_create("String Operations", 1000, ASTHRA_BENCHMARK_MODE_SINGLE_THREADED),
        ...
        {
            .config = asthra_benchmark_config_create("Buffer Operations", 1000, ASTHRA_BENCHMARK_MODE_SINGLE_THREADED),
        ...
        {
            .config = asthra_benchmark_config_create("Atomic Operations", 10000, ASTHRA_BENCHMARK_MODE_SINGLE_THREADED),
