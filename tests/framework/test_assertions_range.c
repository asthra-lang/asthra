...
#pragma GCC diagnostic pop
            snprintf(error_msg, 1024, "%s (value: %d, range: [%d, %d])", formatted_msg, value, min,
                     max);
...
#pragma GCC diagnostic ignored "-Wformat-nonliteral"
            vsnprintf(formatted_msg, sizeof(formatted_msg), message, args);
#pragma GCC diagnostic pop
            snprintf(error_msg, 1024, "%s (value: %ld, range: [%ld, %ld])", formatted_msg, value,
                     min, max);
            context->error_message = error_msg;
            context->error_message_allocated = true;
        }
...
#pragma GCC diagnostic ignored "-Wformat-nonliteral"
            vsnprintf(formatted_msg, sizeof(formatted_msg), message, args);
#pragma GCC diagnostic pop
            snprintf(error_msg, 1024, "%s (value: %zu, range: [%zu, %zu])", formatted_msg, value,
                     min, max);
            context->error_message = error_msg;
            context->error_message_allocated = true;
        }
...
#pragma GCC diagnostic ignored "-Wformat-nonliteral"
            vsnprintf(formatted_msg, sizeof(formatted_msg), message, args);
#pragma GCC diagnostic pop
            snprintf(error_msg, 1024, "%s (value: %f, range: [%f, %f])", formatted_msg, value, min,
                     max);
            context->error_message = error_msg;
            context->error_message_allocated = true;
        }
...
#pragma GCC diagnostic ignored "-Wformat-nonliteral"
            vsnprintf(formatted_msg, sizeof(formatted_msg), message, args);
#pragma GCC diagnostic pop
            snprintf(error_msg, 1024, "%s (value: %p, range: [%p, %p])", formatted_msg, value, min,
                     max);
            context->error_message = error_msg;
            context->error_message_allocated = true;
        }
