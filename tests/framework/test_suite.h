...
AsthraTestSuite* asthra_test_suite_create_detailed(const char *name, const char *description);  // NEW: Detailed mode
...
void asthra_test_suite_set_config(AsthraTestSuite *suite, const AsthraTestSuiteConfig *config);  // NEW
void asthra_test_suite_set_analysis_callback(AsthraTestSuite *suite, AsthraAnalysisCallback callback);  // NEW
...
AsthraTestSuiteConfig asthra_test_suite_config_detailed(const char *name, const char *description);  // NEW
...
AsthraTestResult asthra_test_run_suite_wrapper(AsthraTestSuite *suite);  // Convenience wrapper for suite objects
