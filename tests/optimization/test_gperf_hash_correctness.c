...
static AsthraTestResult test_hash_function_lookup_accuracy(AsthraTestContext *context) {
    ...
    if (!ASTHRA_TEST_ASSERT_EQ(context, exit_code, 0, 
                               "Hash function lookup test should pass")) {
        return ASTHRA_TEST_FAIL;
    }
...
AsthraTestFunction gperf_hash_correctness_tests[] = {
    test_hash_function_compilation,
    test_hash_function_lookup_accuracy,
    test_hash_function_no_collisions,
    test_hash_function_structure
};

AsthraTestMetadata gperf_hash_correctness_metadata[] = {
    {"Hash Function Compilation", __FILE__, __LINE__, "test_hash_function_compilation", ASTHRA_TEST_SEVERITY_HIGH, 0, false, NULL},
    {"Hash Function Lookup Accuracy", __FILE__, __LINE__, "test_hash_function_lookup_accuracy", ASTHRA_TEST_SEVERITY_HIGH, 0, false, NULL},
    {"Hash Function No Collisions", __FILE__, __LINE__, "test_hash_function_no_collisions", ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
    {"Hash Function Structure", __FILE__, __LINE__, "test_hash_function_structure", ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL}
};

const size_t gperf_hash_correctness_test_count = sizeof(gperf_hash_correctness_tests) / sizeof(gperf_hash_correctness_tests[0]); 
