...
AsthraTestFunction gperf_file_generation_tests[] = {stub_file_generation_test};
...
AsthraTestFunction gperf_keyword_extraction_tests[] = {stub_keyword_extraction_test};
...
AsthraTestFunction gperf_hash_correctness_tests[] = {stub_hash_correctness_test};
...
AsthraTestFunction gperf_performance_tests[] = {stub_performance_test};
