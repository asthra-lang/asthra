...
AsthraTestResult test_basic_optimization_concepts(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT_EQ(context, optimized_value, 200, 
        "Optimized value should be 200");
...
AsthraTestResult test_optimization_metrics(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, improvement > 0, 
        "Optimization should show improvement");
...
AsthraTestResult test_optimization_validation(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, files_found > 0, 
        "Should find at least one project file");
...
int main(void) {
    ...
    asthra_test_suite_add_test(suite, "basic_optimization_concepts", 
        "Test basic optimization concepts", test_basic_optimization_concepts);
