...
void test_match_jump_table_optimization(void) {
    ...
    const char *dense_match_code = "fn process_status(status: i32) -> string {\n"
                                   "    match status {\n"
                                   "        0 => \"OK\",\n"
                                   "        1 => \"Warning\",\n"
                                   "        2 => \"Error\",\n"
...
void test_match_binary_search_optimization(void) {
    ...
    const char *sparse_match_code = "fn handle_http_status(code: i32) -> string {\n"
                                    "    match code {\n"
                                    "        200 => \"OK\",\n"
                                    "        201 => \"Created\",\n"
                                    "        204 => \"No Content\",\n"
...
void test_match_enum_optimization(void) {
    ...
    const char *enum_match_code = "enum Status {\n"
                                  "    Active,\n"
                                  "    Inactive,\n"
                                  "    Pending,\n"
                                  "    Completed\n"
...
void test_loop_full_unrolling(void) {
    ...
    const char *small_loop_code = "fn sum_first_five() -> i32 {\n"
                                  "    let mut sum = 0;\n"
                                  "    for i in 0..5 {\n"
                                  "        sum += i;\n"
                                  "    }\n"
...
void test_loop_partial_unrolling(void) {
    ...
    const char *larger_loop_code = "fn process_array(arr: []i32) {\n"
                                   "    for i in 0..100 {\n"
                                   "        arr[i] = arr[i] * 2 + 1;\n"
                                   "    }\n"
                                   "}\n";
