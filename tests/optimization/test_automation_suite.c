...
AsthraTestFunction automation_test_functions[] = {
    test_instruments_profiler_script,
    test_sanitizer_runner_script,
    test_optimization_script_integration
};

AsthraTestMetadata automation_test_metadata[] = {
    {"Instruments Profiler Script", __FILE__, __LINE__, "test_instruments_profiler_script", ASTHRA_TEST_SEVERITY_LOW, 0, false, NULL},
    {"Sanitizer Runner Script", __FILE__, __LINE__, "test_sanitizer_runner_script", ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
    {"Optimization Script Integration", __FILE__, __LINE__, "test_optimization_script_integration", ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL}
};

const size_t automation_test_count = sizeof(automation_test_functions) / sizeof(automation_test_functions[0]); 
