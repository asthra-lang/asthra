...
static AsthraTestResult test_hash_function_scalability(AsthraTestContext *context) {
    ...
    if (!ASTHRA_TEST_ASSERT(context, keyword_count <= 200,
                            "Hash function should not be bloated (%d keywords)", keyword_count)) {
        return ASTHRA_TEST_FAIL;
    }
...
AsthraTestFunction gperf_performance_tests[] = {
    test_hash_function_performance, test_hash_function_memory_efficiency,
    test_hash_function_lookup_speed, test_hash_function_scalability};

AsthraTestMetadata gperf_performance_metadata[] = {
    {"Hash Function Performance", __FILE__, __LINE__, "test_hash_function_performance",
     ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
    {"Hash Function Memory Efficiency", __FILE__, __LINE__, "test_hash_function_memory_efficiency",
     ASTHRA_TEST_SEVERITY_LOW, 0, false, NULL},
    {"Hash Function Lookup Speed", __FILE__, __LINE__, "test_hash_function_lookup_speed",
     ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
    {"Hash Function Scalability", __FILE__, __LINE__, "test_hash_function_scalability",
     ASTHRA_TEST_SEVERITY_LOW, 0, false, NULL}};

const size_t gperf_performance_test_count =
    sizeof(gperf_performance_tests) / sizeof(gperf_performance_tests[0]);
