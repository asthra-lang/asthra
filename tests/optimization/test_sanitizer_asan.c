...
int main(void) {
    ...
    AsthraTestResult results[] = {
        test_asan_buffer_overflow_detection(context),
        test_asan_use_after_free_detection(context),
        test_asan_memory_leak_detection(context),
        test_asan_double_free_detection(context)
    };
