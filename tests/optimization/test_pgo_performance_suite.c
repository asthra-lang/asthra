...
int main(void) {
    ...
    // Define test cases
    AsthraTestFunction tests[] = {test_pgo_fibonacci_benchmark, test_pgo_matrix_benchmark,
                                  test_pgo_sorting_benchmark,   test_pgo_compilation_performance,
                                  test_pgo_memory_usage,        test_pgo_profile_data_quality};

    AsthraTestMetadata metadata[] = {
        {"PGO Fibonacci Benchmark", __FILE__, __LINE__, "test_pgo_fibonacci_benchmark",
         ASTHRA_TEST_SEVERITY_HIGH, 0, false, NULL},
        {"PGO Matrix Benchmark", __FILE__, __LINE__, "test_pgo_matrix_benchmark",
         ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
        {"PGO Sorting Benchmark", __FILE__, __LINE__, "test_pgo_sorting_benchmark",
         ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
        {"PGO Compilation Performance", __FILE__, __LINE__, "test_pgo_compilation_performance",
         ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL},
        {"PGO Memory Usage", __FILE__, __LINE__, "test_pgo_memory_usage", ASTHRA_TEST_SEVERITY_LOW,
         0, false, NULL},
        {"PGO Profile Data Quality", __FILE__, __LINE__, "test_pgo_profile_data_quality",
         ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL}};
