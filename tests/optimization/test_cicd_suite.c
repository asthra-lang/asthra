...
AsthraTestFunction cicd_test_functions[] = {
    test_ci_cd_compatibility,
    test_optimization_test_suite_target
};

AsthraTestMetadata cicd_test_metadata[] = {
    {"CI/CD Compatibility", __FILE__, __LINE__, "test_ci_cd_compatibility", ASTHRA_TEST_SEVERITY_HIGH, 0, false, NULL},
    {"Optimization Test Suite Target", __FILE__, __LINE__, "test_optimization_test_suite_target", ASTHRA_TEST_SEVERITY_MEDIUM, 0, false, NULL}
};
