...
// Basic test framework macros
#define ASTHRA_TEST_PASS 1
#define ASTHRA_TEST_FAIL 0

typedef int AsthraTestResult;
...
#define ASTHRA_TEST_ASSERT(ctx, condition, message, ...) \
    ((ctx)->tests_run++, \
     (!(condition)) ? \
