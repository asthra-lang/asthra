...
void test_tier1_spawn_with_handle_parsing(void) {
    ...
    if (function_node) {
        ...
        if (function_node->data.function_decl.body) {
            found_spawn_with_handle =
                contains_spawn_with_handle_statement(function_node->data.function_decl.body);
...
void test_tier1_nested_spawn_validation(void) {
    ...
    if (outer_task) {
        ...
        bool has_nested_spawn =
            contains_spawn_with_handle_statement(outer_task->data.function_decl.body);
