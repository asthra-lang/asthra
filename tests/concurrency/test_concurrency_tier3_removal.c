...
void test_tier3_keywords_removed(void) {
    ...
    const char *old_keywords[] = {"channel", "send",        "recv",    "select",
                                  "default", "worker_pool", "timeout", "close"};
...
void test_tier3_syntax_errors(void) {
    ...
    const char *old_channel_syntax = "pub fn old_syntax() -> Result<(), string> {\n"
...
void test_tier3_ast_nodes_removed(void) {
    ...
    const char *select_like_syntax = "package test;\n"
                                     "\n"
...
void test_tier3_old_select_statement_syntax(void) {
    ...
    const char *old_select_syntax = "package test;\n"
                                    "\n"
...
void test_tier3_old_worker_pool_syntax(void) {
    ...
    const char *old_worker_pool_syntax = "package test;\n"
                                         "\n"
...
void test_tier3_old_timeout_syntax(void) {
    ...
    const char *old_timeout_syntax = "package test;\n"
                                     "\n"
...
void test_tier3_migration_documentation(void) {
    ...
    const char *migration_example = "package test;\n"
                                    "\n"
                                    "// OLD (Tier 3, removed):\n"
...
void test_tier3_error_messages_helpful(void) {
    ...
    const char *old_syntax_attempt = "package test;\n"
                                     "\n"
...
void test_tier3_backwards_compatibility_none(void) {
    ...
    const char *various_old_syntax[] = {"let ch: chan<i32>;",    "ch <- value;",   "value := <-ch;",
                                        "select { case <-ch: }", "worker_pool(4)", "timeout(1000)"};
