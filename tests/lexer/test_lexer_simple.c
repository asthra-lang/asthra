...
static AsthraTestResult test_operators(AsthraTestContext *ctx) {
    ...
    TokenType expected[] = {TOKEN_PLUS, TOKEN_MINUS, TOKEN_MULTIPLY, TOKEN_DIVIDE, TOKEN_EQUAL, TOKEN_NOT_EQUAL};
...
int main(void) {
    ...
    asthra_test_suite_add_test(suite, "basic_tokens", "Test basic token recognition", test_basic_tokens);
