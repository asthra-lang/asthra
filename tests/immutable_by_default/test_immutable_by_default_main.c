...
int main(void) {
    ...
    // Integration tests
    printf("\n--- Integration Tests ---\n");
    if (test_ffi_immutable_integration())
        passed_tests++;
    total_tests++;
    if (test_smart_optimization_integration())
        passed_tests++;
    total_tests++;

    // Real-world scenario tests
    printf("\n--- Real-World Scenario Tests ---\n");
    if (test_real_world_game_engine_scenario())
        passed_tests++;
    total_tests++;
    if (test_real_world_web_server_scenario())
        passed_tests++;
    total_tests++;

    // Performance and AI tests
    printf("\n--- Performance & AI Generation Tests ---\n");
    if (test_performance_targets_validation())
        passed_tests++;
    total_tests++;
    if (test_ai_friendly_patterns())
        passed_tests++;
    total_tests++;
