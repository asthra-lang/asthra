...
int main(void) {
    ...
    printf("-----------------------------------\n");
    if (test_immutable_by_default_concepts()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.2: Mutable Variable Patterns\n");
    printf("-------------------------------------\n");
    if (test_mutable_variable_patterns()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.3: FFI Integration Concepts\n");
    printf("------------------------------------\n");
    if (test_ffi_integration_concepts()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.4: Smart Optimization Validation\n");
    printf("-----------------------------------------\n");
    if (test_smart_optimization_concepts()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.5: AI Generation Benefits\n");
    printf("----------------------------------\n");
    if (test_ai_generation_benefits()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.6: Real-World Scenarios\n");
    printf("--------------------------------\n");
    if (test_real_world_scenarios()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.7: Performance Validation\n");
    printf("----------------------------------\n");
    if (test_performance_validation()) passed_tests++;
    total_tests++;
    printf("\n");
    
    printf("Phase 4.8: Design Principles Validation\n");
    printf("----------------------------------------\n");
    if (test_design_principles_validation()) passed_tests++;
    total_tests++;
    printf("\n");
