...
static bool test_ffi_parameter_marshaling(void) {
    ...
    bool result = ffi_generate_parameter_marshaling(g_generator, int_param, FFI_MARSHAL_DIRECT,
    ...
    result = ffi_generate_parameter_marshaling(g_generator, string_param, FFI_MARSHAL_STRING,
...
static bool test_ownership_transfer(void) {
    ...
    bool result = ffi_generate_ownership_transfer(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI,
                                                  FFI_OWNERSHIP_MOVE);
    TEST_ASSERT(result, "Full ownership transfer failed");

    // Test no ownership transfer
    result = ffi_generate_ownership_transfer(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI,
                                             FFI_OWNERSHIP_NONE);
...
test_function_t ffi_core_tests[] = {
    test_ffi_extern_call_generation, test_ffi_variadic_call_generation,
    test_ffi_parameter_marshaling,   test_ownership_transfer,
