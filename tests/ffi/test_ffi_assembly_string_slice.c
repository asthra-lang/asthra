...
static bool test_string_concatenation(void) {
    ...
    bool result = ffi_generate_string_concatenation(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RAX);
...
static bool test_slice_bounds_checking(void) {
    ...
    bool result = ffi_generate_slice_bounds_check(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, error_label);
...
static bool test_slice_to_ffi_conversion(void) {
    ...
    bool result = ffi_generate_slice_to_ffi(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RDX);
...
static bool test_slice_indexing(void) {
    ...
    bool result = ffi_generate_slice_index_access(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RAX, true);
    TEST_ASSERT(result, "Slice indexing generation failed");
    
    // Test without bounds check
    result = ffi_generate_slice_index_access(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RAX, false);
...
static bool test_slice_subslicing(void) {
    ...
    bool result = ffi_generate_slice_subslice(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RDX, ASTHRA_REG_RAX);
...
static bool test_slice_iteration(void) {
    ...
    bool result = ffi_generate_slice_iteration_setup(g_generator, ASTHRA_REG_RDI, ASTHRA_REG_RSI, ASTHRA_REG_RDX);
