...
void test_slice_creation(void) {
    ...
    AsthraFFISliceHeader slice1 = Asthra_slice_from_raw_parts(
...
void test_slice_element_access(void) {
    ...
    AsthraFFISliceHeader slice = Asthra_slice_from_raw_parts(
        test_array, 5, sizeof(int), true, ASTHRA_OWNERSHIP_TRANSFER_NONE);
...
// Test registration
static test_case_t slice_tests[] = {
    {"Slice Creation", test_slice_creation},
