...
typedef enum { TARGET_ARCH_X86_64, TARGET_ARCH_COUNT } TargetArchitecture;

typedef enum { CALLING_CONV_SYSTEM_V_AMD64, CALLING_CONV_COUNT } CallingConvention;
...
// Slice operations
bool minimal_generate_slice_length_access(MinimalFFIAssemblyGenerator *generator,
                                          Register slice_reg, Register result_reg);
bool minimal_generate_slice_bounds_check(MinimalFFIAssemblyGenerator *generator, Register slice_reg,
                                         Register index_reg, const char *error_label);
bool minimal_generate_slice_to_ffi(MinimalFFIAssemblyGenerator *generator, Register slice_reg,
                                   Register ptr_reg, Register len_reg);
