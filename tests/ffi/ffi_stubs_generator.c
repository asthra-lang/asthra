...
bool enhanced_generate_string_concatenation(EnhancedFFIGenerator *gen, const char *str1,
    ...
    bool success = ffi_generate_string_concatenation(gen->real_generator, ASTHRA_REG_RAX,
                                                     ASTHRA_REG_RBX, ASTHRA_REG_RCX);
...
bool enhanced_generate_slice_length_access(EnhancedFFIGenerator *gen, void *slice_ptr,
    ...
    bool success =
        ffi_generate_slice_length_access(gen->real_generator, ASTHRA_REG_RAX, target_reg);
    update_generation_stats(gen, success);
...
bool enhanced_generate_slice_bounds_check(EnhancedFFIGenerator *gen, void *slice_ptr, size_t index,
    ...
    bool success = ffi_generate_slice_bounds_check(gen->real_generator, ASTHRA_REG_RAX, index_reg,
                                                   bounds_error_label);
    update_generation_stats(gen, success);
...
bool enhanced_generate_volatile_memory_access(EnhancedFFIGenerator *gen, void *memory_ptr,
    ...
    bool success =
        ffi_generate_volatile_memory_access(gen->real_generator, ASTHRA_REG_RAX, size, true);
    update_generation_stats(gen, success);
...
bool enhanced_generate_task_creation(EnhancedFFIGenerator *gen, const char *task_name) {
    ...
    ASTNode mock_spawn_stmt = {.type = AST_SPAWN_STMT,
...
bool minimal_generate_slice_length_access(MinimalFFIGenerator *gen) {
    ...
    return enhanced_generate_slice_length_access((EnhancedFFIGenerator *)gen, dummy_slice,
                                                 ASTHRA_REG_RAX);
}

bool minimal_generate_slice_bounds_check(MinimalFFIGenerator *gen) {
    static char dummy_slice[10] = {0};
    return enhanced_generate_slice_bounds_check((EnhancedFFIGenerator *)gen, dummy_slice, 5,
                                                ASTHRA_REG_RCX);
}

bool minimal_generate_slice_to_ffi(MinimalFFIGenerator *gen) {
    static char dummy_slice[10] = {0};
    return enhanced_generate_slice_to_ffi((EnhancedFFIGenerator *)gen, dummy_slice, ASTHRA_REG_RDI,
                                          ASTHRA_REG_RSI);
}

bool minimal_generate_volatile_memory_access(MinimalFFIGenerator *gen) {
    static volatile char dummy_memory[8] = {0};
    return enhanced_generate_volatile_memory_access((EnhancedFFIGenerator *)gen,
                                                    (void *)dummy_memory, 8);
}
