...
static bool test_if_let_statement(void) {
    ...
    ast_node_list_add(&then_branch->data.block.statements, create_test_integer_literal(42));
    ...
    ast_node_list_add(&else_branch->data.block.statements, create_test_integer_literal(0));
