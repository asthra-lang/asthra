...
static void test_ffi_error_with_location(void) {
    ...
    AsthraCFFIError *error =
        asthra_ffi_error_create_with_location(EINVAL, "test", "test_file.c", 42);
...
static void test_ffi_error_to_string(void) {
    AsthraCFFIError *error = asthra_ffi_error_create_with_location(ENOENT, "fs", "main.c", 123);
