...
bool enhanced_ffi_generate_parameter_marshaling(void *param, size_t size,
    ...
    ASTNode mock_param = {.type = AST_PARAM_DECL,
    ...
    bool success = ffi_generate_parameter_marshaling(global_marshaler.ffi_generator, &mock_param,
                                                     FFI_MARSHAL_DIRECT, // marshal type
                                                     transfer_type, target_reg);
...
bool enhanced_ffi_generate_extern_call(const char *function_name, void **params, size_t param_count,
    ...
    ASTNode mock_extern_call = {.type = AST_CALL_EXPR,
                                .location = {0}, // Default source location
                                .type_info = NULL,
                                .ref_count = 1,
                                .flags = {0}};
    ...
    bool success = ffi_generate_extern_call(global_marshaler.ffi_generator, &mock_extern_call);
...
bool enhanced_ffi_generate_variadic_call(const char *function_name, void **params,
    ...
    ASTNode mock_variadic_call = {.type = AST_CALL_EXPR,
                                  .location = {0}, // Default source location
                                  .type_info = NULL,
                                  .ref_count = 1,
                                  .flags = {0}};
    ...
    bool success = ffi_generate_variadic_call(global_marshaler.ffi_generator, &mock_variadic_call,
                                              param_count);
