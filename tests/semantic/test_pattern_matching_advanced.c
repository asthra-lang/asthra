...
AsthraTestResult test_guard_conditions(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT(
        ...
        test_pattern_error(
            ...
            "    }\n"
            "}\n",
            SEMANTIC_ERROR_INCOMPATIBLE_TYPES, "non_bool_guard_condition"),
...
AsthraTestResult test_if_let_statements(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT(
        ...
        test_pattern_error("package test;\n"
                           ...
                           "    return 0;\n"
                           "}\n",
                           SEMANTIC_ERROR_INCOMPATIBLE_TYPES, "if_let_type_mismatch"),
        "Type mismatch in if-let should fail");

    // Nested if-let
    ASTHRA_TEST_ASSERT(
        context,
        test_pattern_success(
            "package test;\n"
            "pub enum TestOption<T> {\n"
            "    Some(T),\n"
            "    None\n"
...
AsthraTestResult test_pattern_variable_binding(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT(
        ...
        test_pattern_error("package test;\n"
                           ...
                           "    }\n"
                           "}\n",
                           SEMANTIC_ERROR_UNDEFINED_SYMBOL, "unbound_pattern_variable"),
...
AsthraTestResult test_type_compatibility_in_patterns(AsthraTestContext *context) {
    ...
    ASTHRA_TEST_ASSERT(
        ...
        test_pattern_error("package test;\n"
                           ...
                           "    }\n"
                           "}\n",
                           SEMANTIC_ERROR_INCOMPATIBLE_TYPES, "incompatible_match_arms"),
