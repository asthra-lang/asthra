...
ASTHRA_TEST_DEFINE(test_slice_type_checking, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "slice_type_checking"),
...
ASTHRA_TEST_DEFINE(test_slice_type_mismatch, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_error(source, SEMANTIC_ERROR_TYPE_MISMATCH, "slice_type_mismatch"),
...
ASTHRA_TEST_DEFINE(test_struct_type_checking, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "struct_type_checking"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {
        test_slice_type_checking_metadata,
        test_slice_type_mismatch_metadata,
        test_struct_type_checking_metadata,
        test_struct_field_type_mismatch_metadata
    };
    
    AsthraTestFunction test_functions[] = {
        test_slice_type_checking,
        test_slice_type_mismatch,
    ...
    AsthraTestSuiteConfig config = {
        ...
        .description = "Tests for semantic analyzer composite type checking",
