...
ASTHRA_TEST_DEFINE(test_function_parameter_read, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_mutability_success(source, "function_parameter_read"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {test_function_parameter_immutable_metadata,
                                          test_function_parameter_read_metadata,
                                          test_function_slice_parameter_modification_metadata};

    AsthraTestFunction test_functions[] = {test_function_parameter_immutable,
    ...
    AsthraTestSuiteConfig config = {.name = "Function Parameter Mutability Tests",
                                    .description =
                                        "Tests for function parameter immutability semantics",
