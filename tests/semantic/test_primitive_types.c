...
ASTHRA_TEST_DEFINE(test_primitive_int_type, ASTHRA_TEST_SEVERITY_CRITICAL) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_type_check_success(source, "primitive_int_type"),
...
ASTHRA_TEST_DEFINE(test_primitive_float_type, ASTHRA_TEST_SEVERITY_CRITICAL) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_type_check_success(source, "primitive_float_type"),
...
ASTHRA_TEST_DEFINE(test_primitive_bool_type, ASTHRA_TEST_SEVERITY_CRITICAL) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_type_check_success(source, "primitive_bool_type"),
...
ASTHRA_TEST_DEFINE(test_primitive_string_type, ASTHRA_TEST_SEVERITY_CRITICAL) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_type_check_success(source, "primitive_string_type"),
...
ASTHRA_TEST_DEFINE(test_unknown_type_error, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(
        context, test_type_check_error(source, SEMANTIC_ERROR_UNDEFINED_TYPE, "unknown_type_error"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {
        test_primitive_int_type_metadata,      test_primitive_float_type_metadata,
        test_primitive_bool_type_metadata,     test_primitive_string_type_metadata,
        test_primitive_type_mismatch_metadata, test_unknown_type_error_metadata};

    AsthraTestFunction test_functions[] = {test_primitive_int_type,      test_primitive_float_type,
                                           test_primitive_bool_type,     test_primitive_string_type,
                                           test_primitive_type_mismatch, test_unknown_type_error};

    size_t test_count = sizeof(test_functions) / sizeof(test_functions[0]);

    AsthraTestSuiteConfig config = {.name = "Primitive Type Tests",
                                    .description =
                                        "Tests for semantic analyzer primitive type checking",
