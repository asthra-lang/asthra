...
ASTHRA_TEST_DEFINE(test_sized_integer_types, ASTHRA_TEST_SEVERITY_MEDIUM) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "sized_integer_types"),
...
ASTHRA_TEST_DEFINE(test_enum_type_checking, ASTHRA_TEST_SEVERITY_MEDIUM) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "enum_type_checking"),
...
ASTHRA_TEST_DEFINE(test_generic_struct_type, ASTHRA_TEST_SEVERITY_MEDIUM) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_error(source, SEMANTIC_ERROR_INVALID_TYPE, "generic_struct_type"),
...
int main(void) {
    ...
    AsthraTestSuiteConfig config = {
        .name = "Advanced Type Tests",
        .description = "Tests for semantic analyzer advanced type checking",
