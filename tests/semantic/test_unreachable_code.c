...
static AsthraTestResult test_unreachable_after_panic(AsthraTestContext *ctx) {
    ...
    bool has_warnings = asthra_test_assert_size_eq(
        ctx, warning_count, 2, "Expected 2 warnings for unreachable code after panic()");
...
static AsthraTestResult test_unreachable_in_if_branches(AsthraTestContext *ctx) {
    ...
    bool has_warning = asthra_test_assert_size_eq(
        ctx, warning_count, 1, "Expected 1 warning for unreachable code in if branch");
...
static AsthraTestResult test_unreachable_after_never_expression(AsthraTestContext *ctx) {
    ...
    bool has_warning = asthra_test_assert_bool(
        ctx, warning_count >= 1,
...
AsthraTestSuite *create_unreachable_code_test_suite(void) {
    ...
    asthra_test_suite_add_test(suite, "test_unreachable_after_panic",
                               "Test unreachable code after panic", test_unreachable_after_panic);
...
int main(void) {
    ...
    printf(
        "Note: These tests explore unreachable code detection after Never-returning functions.\n");
