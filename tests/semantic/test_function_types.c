...
ASTHRA_TEST_DEFINE(test_function_parameter_types, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "function_parameter_types"),
...
ASTHRA_TEST_DEFINE(test_function_parameter_type_mismatch, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_error(source, SEMANTIC_ERROR_INVALID_ARGUMENTS, "function_parameter_type_mismatch"),
...
ASTHRA_TEST_DEFINE(test_function_return_type, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "function_return_type"),
...
ASTHRA_TEST_DEFINE(test_function_return_type_mismatch, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_error(source, SEMANTIC_ERROR_INVALID_RETURN, "function_return_type_mismatch"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {
        test_function_parameter_types_metadata,
        test_function_parameter_type_mismatch_metadata,
        test_function_return_type_metadata,
        test_function_return_type_mismatch_metadata
    };
    
    AsthraTestFunction test_functions[] = {
        test_function_parameter_types,
        test_function_parameter_type_mismatch,
    ...
    AsthraTestSuiteConfig config = {
        .name = "Function Type Tests",
        .description = "Tests for semantic analyzer function type checking",
