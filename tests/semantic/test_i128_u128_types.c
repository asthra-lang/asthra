...
ASTHRA_TEST_DEFINE(test_i128_type_declaration, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_type_declaration"),
...
ASTHRA_TEST_DEFINE(test_u128_type_declaration, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "u128_type_declaration"),
...
ASTHRA_TEST_DEFINE(test_i128_u128_arithmetic, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_u128_arithmetic"),
...
ASTHRA_TEST_DEFINE(test_i128_u128_bitwise, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_u128_bitwise"),
...
ASTHRA_TEST_DEFINE(test_i128_u128_comparisons, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_u128_comparisons"),
...
ASTHRA_TEST_DEFINE(test_i128_u128_type_mismatch, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_u128_type_mismatch"),
...
ASTHRA_TEST_DEFINE(test_i128_mixed_types, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_mixed_types"),
...
ASTHRA_TEST_DEFINE(test_i128_u128_function_params, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, 
        test_type_check_success(source, "i128_u128_function_params"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {
        test_i128_type_declaration_metadata,
        test_u128_type_declaration_metadata,
        test_i128_u128_arithmetic_metadata,
        test_i128_u128_bitwise_metadata,
        test_i128_u128_comparisons_metadata,
        test_i128_u128_type_mismatch_metadata,
        test_i128_mixed_types_metadata,
        test_i128_u128_function_params_metadata
    };
    
    AsthraTestFunction test_functions[] = {
        test_i128_type_declaration,
        test_u128_type_declaration,
        test_i128_u128_arithmetic,
        test_i128_u128_bitwise,
        test_i128_u128_comparisons,
        test_i128_u128_type_mismatch,
        test_i128_mixed_types,
        test_i128_u128_function_params
    };
    
    size_t test_count = sizeof(test_functions) / sizeof(test_functions[0]);
    
    AsthraTestSuiteConfig config = {
        .name = "128-bit Integer Type Tests",
