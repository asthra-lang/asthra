...
ASTHRA_TEST_DEFINE(test_immutable_struct_field_access, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_mutability_success(source, "immutable_struct_field_read"),
...
ASTHRA_TEST_DEFINE(test_immutable_struct_field_modification_error, ASTHRA_TEST_SEVERITY_HIGH) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context,
                            test_mutability_error(source, SEMANTIC_ERROR_IMMUTABLE_MODIFICATION,
                                                  "immutable_struct_field_modification"),
...
ASTHRA_TEST_DEFINE(test_nested_struct_mutability, ASTHRA_TEST_SEVERITY_MEDIUM) {
    ...
    ASTHRA_TEST_ASSERT_TRUE(context, test_mutability_success(source, "nested_struct_mutability"),
...
int main(void) {
    ...
    AsthraTestMetadata test_metadata[] = {test_immutable_struct_field_access_metadata,
    ...
    AsthraTestFunction test_functions[] = {
        test_immutable_struct_field_access, test_immutable_struct_field_modification_error,
        test_mutable_struct_field_modification, test_nested_struct_mutability};

    size_t test_count = sizeof(test_functions) / sizeof(test_functions[0]);

    AsthraTestSuiteConfig config = {.name = "Struct Mutability Tests",
