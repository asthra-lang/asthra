...
int test_package_structure(void) {
    const char *required_files[] = {
        "../stdlib/toml/mod.asthra",    "../stdlib/toml/common.asthra",
        "../stdlib/toml/parser.asthra", "../stdlib/toml/generator.asthra",
        "../stdlib/toml/table.asthra",  "../stdlib/toml/utils.asthra"};
...
int test_package_declarations(void) {
    const char *files[] = {"../stdlib/toml/mod.asthra",    "../stdlib/toml/common.asthra",
                           "../stdlib/toml/parser.asthra", "../stdlib/toml/generator.asthra",
                           "../stdlib/toml/table.asthra",  "../stdlib/toml/utils.asthra"};
...
int test_core_types(void) {
    ...
    const char *required_types[] = {"enum TomlValueType",  "enum TomlValue", "struct TomlTable",
                                    "struct TomlDocument", "enum TomlError", "enum TomlResult",
                                    "struct TomlConfig"};
...
int test_parser_functions(void) {
    ...
    const char *required_functions[] = {
        "pub fn parse_string(",        "pub fn parse_string_with_config(", "pub fn parse_file(",
        "pub fn new_parser(",          "pub fn parse_document(",           "pub fn parse_value(",
...
int test_generator_functions(void) {
    ...
    const char *required_functions[] = {
        "pub fn generate_string(",  "pub fn generate_string_with_config(",
        "pub fn generate_file(",    "pub fn generate_pretty(",
        "pub fn generate_compact(", "pub fn new_generator(",
...
int test_table_operations(void) {
    ...
    const char *required_functions[] = {"pub fn table_get(",         "pub fn table_set(",
                                        "pub fn table_contains(",    "pub fn table_remove(",
                                        "pub fn table_clone(",       "pub fn table_merge(",
                                        "pub fn table_get_path(",    "pub fn table_get_string(",
                                        "pub fn table_get_integer(", "pub fn table_get_boolean("};
...
int test_utility_functions(void) {
    ...
    const char *required_functions[] = {
        "pub fn get_value_from_string(", "pub fn get_value_from_file(",
        "pub fn is_valid_toml(",         "pub fn validate_toml_file(",
        "pub fn value_to_string(",       "pub fn extract_string_array(",
        "pub fn new_config_loader(",     "pub fn validate_against_schema("};
...
int test_error_handling(void) {
    ...
    const char *required_error_types[] = {
        "TomlParseError",     "TomlTypeError",     "TomlKeyError",        "pub fn parse_error(",
        "pub fn type_error(", "pub fn key_error(", "pub fn format_error("};
...
int test_value_types_completeness(void) {
    ...
    const char *required_value_types[] = {"String,",   "Integer,", "Float,", "Boolean,",
                                          "DateTime,", "Array,",   "Table,", "InlineTable,"};
...
int test_configuration_support(void) {
    ...
    const char *config_features[] = {"struct TomlConfig", "struct ConfigLoader",
                                     "pub fn default_config(", "pub fn lenient_config("};
...
int test_external_dependencies(void) {
    const char *files[] = {"../stdlib/toml/parser.asthra", "../stdlib/toml/generator.asthra",
                           "../stdlib/toml/table.asthra", "../stdlib/toml/utils.asthra"};
