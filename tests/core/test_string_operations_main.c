...
static const StringTestCase string_test_cases[] = {
    // Deterministic behavior tests
    {
        ...
        test_string_deterministic_concatenation,
        "Deterministic",
        false
    },
    {
        "Deterministic Interpolation",
        test_string_deterministic_interpolation,
        "Deterministic",
        false
    },
    {
        "Cross-Platform Consistency",
        test_string_cross_platform_consistency,
        "Deterministic",
        false
    },
    ...
    },
    {
        ...
        test_string_performance_comparison,
        "Performance",
        true
    },
    ...
    {
        "C String Conversion",
        test_string_c_string_conversion,
        "FFI Integration",
        false
    },
    {
        "FFI Ownership Transfer",
        test_string_ffi_ownership_transfer,
        "FFI Integration",
        false
    },
    {
        "FFI Borrowed References",
        test_string_ffi_borrowed_references,
        "FFI Integration",
        false
    }
};
...
AsthraTestResult run_string_operations_test_suite(void) {
    ...
    for (size_t i = 0; i < string_test_count; i++) {
        ...
        printf("\n[%zu/%zu] Running %s (%s)...\n", 
               i + 1, string_test_count, test_case->name, test_case->category);
