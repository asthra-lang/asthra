...
bool validate_multiline_strings_feature(const TestSuiteConfig* config) {
    const char* test_programs[] = {
        ...
        "package main; pub fn main(none) -> void { let x: string = \"\"\"processed\nmultiline\"\"\";}",
...
bool validate_function_declarations_feature(const TestSuiteConfig* config) {
    const char* test_programs[] = {
        ...
        "package main; priv fn add(a: int, b: int) -> int { return a + b; } pub fn main(none) -> void {}",
        "package main; priv fn greet(name: string) -> string { return \"Hello \" + name; } pub fn main(none) -> void {}",
    };
...
bool validate_if_let_feature(const TestSuiteConfig* config) {
    const char* test_programs[] = {
        "package main; priv fn test(opt: Option<int>) -> void { if let Option.Some(x) = opt {} } pub fn main(none) -> void {}",
        "package main; priv fn test(result: Result<int, string>) -> void { if let Result.Ok(x) = result {} } pub fn main(none) -> void {}",
    };
