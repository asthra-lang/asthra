...
static AsthraTestResult test_result_without_declaration(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_bool(context, success,
                                 "Result type should be recognized without declaration")) {
        return ASTHRA_TEST_FAIL;
    }
...
static AsthraTestResult test_result_pattern_matching(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_bool(context, strlen(source) > 100,
                                 "Source code should be substantial")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    if (!asthra_test_assert_bool(context, has_ok_construct,
                                 "Should contain Result.Ok construction")) {
        return ASTHRA_TEST_FAIL;
    }
    if (!asthra_test_assert_bool(context, has_err_construct,
                                 "Should contain Result.Err construction")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    if (!asthra_test_assert_bool(context, success,
                                 "Result pattern matching should work correctly")) {
        return ASTHRA_TEST_FAIL;
    }
...
static AsthraTestResult test_result_type_inference(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_bool(context, strlen(source) > 150,
                                 "Source code should be substantial")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    if (!asthra_test_assert_bool(context, has_type_annotation,
                                 "Should contain explicit type annotation")) {
        return ASTHRA_TEST_FAIL;
    }
    if (!asthra_test_assert_bool(context, has_function_call,
                                 "Should contain function call with none")) {
        return ASTHRA_TEST_FAIL;
    }
...
static AsthraTestResult test_nested_result_types(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_bool(context, has_complex_operation,
                                 "Should contain complex_operation function")) {
        return ASTHRA_TEST_FAIL;
    }
...
static AsthraTestResult test_result_with_option(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_bool(context, has_result_option,
                                 "Should contain Result<Option<T>, E> type")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    bool success = compile_and_verify_result_program(context, source);
    if (!asthra_test_assert_bool(context, success,
                                 "Result with Option types should work together")) {
        return ASTHRA_TEST_FAIL;
    }
...
int main(void) {
    ...
    AsthraTestMetadata metadata = {.name = "builtin_result_type_tests",
                                   .file = __FILE__,
                                   .line = __LINE__,
                                   .function = "main",
