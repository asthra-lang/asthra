...
static const char *LARGE_VARIABLE_PROGRAM_TEMPLATE = "package main;\n"
                                                     "\n"
                                                     "pub fn main(none) -> void {\n";

// Test 2: Deeply Nested Control Flow
static const char *DEEP_NESTING_TEMPLATE = "package main;\n"
                                           "\n"
                                           "pub fn main(none) -> void {\n";
...
RealProgramTestSuite *create_performance_test_suite(void) {
    ...
    RealProgramTest tests[] = {{.name = "large_program_performance",
