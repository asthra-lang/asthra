...
int main(void) {
    ...
    AsthraTestSuiteConfig config = {
        .name = "Static Analysis Integration Tests",
        .description = "Comprehensive tests for C17 static analysis integration",
    ...
    AsthraTestFunction tests[] = {
        test_static_analysis_attributes,
    ...
    AsthraTestMetadata metadata[] = {
        {
            .name = "test_static_analysis_attributes",
            .file = __FILE__,
            .line = __LINE__,
