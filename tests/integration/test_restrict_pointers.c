...
AsthraTestResult test_restrict_pointer_operations(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_pointer(context, ptr, 
    ...
    if (!asthra_test_assert_bool(context, (addr % 32) == 0, 
    ...
    if (!asthra_test_assert_pointer(context, array, 
                                   "Array allocation should succeed")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    if (!asthra_test_assert_pointer(context, array, 
                                   "Array reallocation should succeed")) {
        return ASTHRA_TEST_FAIL;
    }
...
int main(void) {
    ...
    AsthraTestMetadata metadata = {
        .name = "restrict_pointer_operations",
        .file = __FILE__,
        .line = __LINE__,
