...
AsthraTestResult test_const_correct_string_operations(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_size_eq(context, length, 14, 
                                   "String length should be 14")) {
    ...
    if (!asthra_test_assert_int_eq(context, cmp1, 0, 
...
AsthraTestResult test_const_correct_memory_operations(AsthraTestContext *context) {
    ...
    if (!asthra_test_assert_int_eq(context, cmp, 0, 
                                  "Identical memory should compare equal")) {
        return ASTHRA_TEST_FAIL;
    }
    ...
    if (!asthra_test_assert_bool(context, all_set, 
...
int main(void) {
    ...
    AsthraTestMetadata metadata1 = {
        .name = "const_correct_string_operations",
        .file = __FILE__,
        .line = __LINE__,
    ...
    AsthraTestMetadata metadata2 = {
        .name = "const_correct_memory_operations",
        .file = __FILE__,
        .line = __LINE__,
    ...
    if (!context1 || !context2) {
        ...
        if (context1) asthra_test_context_destroy(context1);
        if (context2) asthra_test_context_destroy(context2);
