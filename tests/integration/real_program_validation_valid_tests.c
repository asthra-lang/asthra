...
static const char* MINIMAL_PROGRAM = 
    "package main;\n"
    "\n"
...
static const char* TYPE_USAGE_PROGRAM = 
    "package main;\n"
    "\n"
    "pub fn main(none) -> void {\n"
    "    let number: int = 42;\n"
...
static const char* FUNCTION_WITH_PARAMS_PROGRAM = 
    "package main;\n"
    "\n"
...
static const char* CONTROL_FLOW_PROGRAM = 
    "package main;\n"
    "\n"
    "pub fn main(none) -> void {\n"
    "    let x: int = 42;\n"
...
static const char* MULTILINE_STRING_PROGRAM = 
    "package main;\n"
    "\n"
    "pub fn main(none) -> void {\n"
    "    let config: string = r\"\"\"{\n"
...
static const char* ARRAY_PROGRAM = 
    "package main;\n"
    "\n"
    "pub fn main(none) -> void {\n"
...
static const char* IF_LET_PROGRAM = 
    "package main;\n"
    "\n"
...
static const char* NESTED_STRUCTURES_PROGRAM = 
    "package main;\n"
    "\n"
    "pub fn main(none) -> void {\n"
    "    if true {\n"
...
RealProgramTestSuite* create_valid_program_test_suite(void) {
    RealProgramTestSuite* suite = create_real_program_test_suite(
        "Valid Program Tests", 
        "Tests that validate complete programs parse successfully");
