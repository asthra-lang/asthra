...
static const char *TYPE_MISMATCH_PROGRAM = "package main;\n"
                                           "\n"
...
static const char *MISSING_PACKAGE_PROGRAM = "pub fn main(none) -> void {\n"
                                             "    let x: int = 42;\n"
                                             "}";
...
static const char *UNCLOSED_BLOCK_PROGRAM = "package main;\n"
                                            "\n"
                                            "pub fn main(none) -> void {\n"
                                            "    let x: int = 42;\n"
                                            "    if x > 0 {\n"
...
static const char *INVALID_FUNCTION_CALL_PROGRAM = "package main;\n"
                                                   "\n"
                                                   "pub fn main(none) -> void {\n"
...
RealProgramTestSuite *create_invalid_program_test_suite(void) {
    RealProgramTestSuite *suite = create_real_program_test_suite(
        "Invalid Program Tests", "Tests that validate error detection for invalid programs");
