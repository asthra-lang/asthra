...
static AsthraTestResult test_multiple_structs_integration(AsthraTestContext *context) {
    ...
    const char *source = "package test_multiple_structs;\n"
                         "\n"
                         "pub struct Point {\n"
                         "    pub x: f64,\n"
                         "    pub y: f64\n"
...
static AsthraTestResult test_error_handling_integration(AsthraTestContext *context) {
    ...
    const char *valid_source = "package test_error_handling;\n"
                               "\n"
    ...
    if (!asthra_test_assert_bool(context, strlen(valid_source) > 50,
                                 "Valid source should be substantial")) {
        return ASTHRA_TEST_FAIL;
    }
...
static AsthraTestResult run_integration_pub_impl_self_test_suite(void) {
    ...
    AsthraTestMetadata metadata = {.name = "pub impl self Integration",
                                   .file = __FILE__,
                                   .line = __LINE__,
                                   .function = __func__,
    ...
    } tests[] = {{"Full Integration", test_full_integration},
