...
BinaryOperator token_to_binary_op(TokenType token_type) {
    switch (token_type) {
        ...
        case TOKEN_MULTIPLY: return BINOP_MUL;
        case TOKEN_DIVIDE: return BINOP_DIV;
        case TOKEN_MODULO: return BINOP_MOD;
        case TOKEN_EQUAL: return BINOP_EQ;
        case TOKEN_NOT_EQUAL: return BINOP_NE;
        case TOKEN_LESS_THAN: return BINOP_LT;
        case TOKEN_LESS_EQUAL: return BINOP_LE;
        case TOKEN_GREATER_THAN: return BINOP_GT;
        case TOKEN_GREATER_EQUAL: return BINOP_GE;
        case TOKEN_LOGICAL_AND: return BINOP_AND;
        case TOKEN_LOGICAL_OR: return BINOP_OR;
        case TOKEN_BITWISE_AND: return BINOP_BITWISE_AND;
        case TOKEN_BITWISE_OR: return BINOP_BITWISE_OR;
        case TOKEN_BITWISE_XOR: return BINOP_BITWISE_XOR;
        case TOKEN_LEFT_SHIFT: return BINOP_LSHIFT;
        case TOKEN_RIGHT_SHIFT: return BINOP_RSHIFT;
        default: return BINOP_ADD; // Default, should not happen
    }
}
...
UnaryOperator token_to_unary_op(TokenType token_type) {
    switch (token_type) {
        ...
        case TOKEN_LOGICAL_NOT: return UNOP_NOT;
        case TOKEN_BITWISE_NOT: return UNOP_BITWISE_NOT;
        case TOKEN_MULTIPLY: return UNOP_DEREF;
        case TOKEN_BITWISE_AND: return UNOP_ADDRESS_OF;
        case TOKEN_SIZEOF: return UNOP_SIZEOF;
        default: return UNOP_MINUS; // Default, should not happen
    }
}
