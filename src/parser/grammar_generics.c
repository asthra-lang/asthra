 ...
 */
static ASTNode *parse_generic_enum_constructor(Parser *parser, char *enum_name, ASTNodeList *type_args, SourceLocation start_loc) {
    if (!parser || !enum_name || !type_args) return NULL;
