...
struct ASTNode {
    ...
    union {
        ...
        struct {
            ...
            ASTNodeList
                *type_params; // Optional type parameters (e.g., Vec<T>) - Phase 2: Generic Structs
            VisibilityType visibility; // NEW: pub or private visibility
            ASTNodeList *annotations;  // Phase 2.1: Flexible array
        } struct_decl;
        ...
        struct {
            ...
            ASTNodeList *type_args; // Optional type arguments (e.g., <i32> in Vec<i32>::new()) -
        ...
        struct {
            ...
            ASTNodeList *type_args;   // Optional type arguments (e.g., <i32> in Vec<i32> { ... }) -
                                      // Phase 2: Generic Structs
        ...
        struct {
            char *name;
            ASTNodeList *type_args; // Optional type arguments (e.g., <T> in Vec<T>) - Phase 2:
                                    // Generic Structs
        } struct_type;
