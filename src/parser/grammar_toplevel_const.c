    ...
    case AST_UNARY_EXPR: {
        ...
        if (expr->data.unary_expr.operator== UNOP_SIZEOF) {
            ...
            const_expr->data.const_expr.data.unary.operand =
                convert_expr_to_const_expr(expr->data.unary_expr.operand);
