    ...
    switch (expr->type) {
        ...
        case AST_CALL_EXPR: {
            ...
            if (!func_type || func_type->category != TYPE_FUNCTION) {
                if (func_type) type_descriptor_release(func_type);
                return NULL;
            }
        ...
        case AST_FIELD_ACCESS: {
            ...
            if (!object || !field_name) return NULL;
            ...
            if (object_type->data.struct_type.fields) {
                SymbolEntry *field_symbol = symbol_table_lookup_safe(
                    object_type->data.struct_type.fields, field_name);
        ...
        case AST_BINARY_EXPR: {
            ...
            if (!left_type || !right_type) {
                if (left_type) type_descriptor_release(left_type);
                if (right_type) type_descriptor_release(right_type);
                return NULL;
            }
        ...
        case AST_IF_STMT: {
            ...
            if (!then_type || !else_type) {
                if (then_type) type_descriptor_release(then_type);
                if (else_type) type_descriptor_release(else_type);
                return NULL;
            }
