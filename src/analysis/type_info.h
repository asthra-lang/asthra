    ...
    union {
        ...
        struct {
            enum PrimitiveInfoKind {
                PRIMITIVE_INFO_I8, PRIMITIVE_INFO_I16, PRIMITIVE_INFO_I32, PRIMITIVE_INFO_I64,
                PRIMITIVE_INFO_U8, PRIMITIVE_INFO_U16, PRIMITIVE_INFO_U32, PRIMITIVE_INFO_U64,
 ...
 */
bool type_info_struct_add_field(TypeInfo *struct_type, const char *field_name, 
                               TypeInfo *field_type, size_t offset);
