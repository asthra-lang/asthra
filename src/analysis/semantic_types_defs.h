...
typedef enum {
    PRIMITIVE_VOID,
    PRIMITIVE_BOOL,
    PRIMITIVE_I8, PRIMITIVE_I16, PRIMITIVE_I32, PRIMITIVE_I64, PRIMITIVE_I128, PRIMITIVE_ISIZE,
    PRIMITIVE_U8, PRIMITIVE_U16, PRIMITIVE_U32, PRIMITIVE_U64, PRIMITIVE_U128, PRIMITIVE_USIZE,
    PRIMITIVE_F32, PRIMITIVE_F64,
    PRIMITIVE_CHAR, PRIMITIVE_STRING,
