...
static const ParameterDefinition CACHE_FRIENDLY_PARAMS[] = {
    ...
    {ANNOTATION_PARAM_IDENT, false, "strategy",
     .validation.enum_values = {(const char *[]){"temporal", "spatial", "both", NULL}}}};
...
static const AnnotationConflict ANNOTATION_CONFLICTS[] = {
    ...
    {"inline", "no_inline", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Choose either inline or no_inline, not both"},
    ...
    {"stable", "experimental", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Stable and experimental are contradictory"},
    {"stable", "deprecated", CONFLICT_REDUNDANT, "Stable should not be deprecated"},

    // Concurrency conflicts
    {"atomic", "non_deterministic", CONFLICT_DEPRECATED_COMBINATION,
     "Atomic operations with non_deterministic may indicate design issues"},

    // Memory conflicts
    {"no_gc", "stack_only", CONFLICT_REDUNDANT, "stack_only implies no_gc"},

    // FFI conflicts
    {"dll_export", "dll_import", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Function cannot be both exported and imported"},
    ...
    {"transfer_full", "transfer_none", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Cannot specify both transfer_full and transfer_none"},
    {"transfer_full", "borrowed", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Cannot specify both transfer_full and borrowed"},
    {"transfer_none", "borrowed", CONFLICT_MUTUALLY_EXCLUSIVE,
     "Cannot specify both transfer_none and borrowed"},
