 ...
 */
char *generate_fixit_suggestion(SemanticErrorCode code, const char *context);
 ...
 */
DiagnosticContext *extract_diagnostic_context(SourceLocation location, const char *label);

/**
 * Add a secondary location to diagnostic context
 */
void add_secondary_location(DiagnosticContext *context, SourceLocation location, const char *label);
