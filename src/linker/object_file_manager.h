...
struct Asthra_ObjectRelocation {
    ...
    enum { ASTHRA_RELOC_ABSOLUTE, ASTHRA_RELOC_RELATIVE, ASTHRA_RELOC_PLT, ASTHRA_RELOC_GOT } type;
    int64_t addend;
 ...
 */
bool asthra_object_manager_is_file_loaded(Asthra_ObjectFileManager *manager, const char *file_path);
