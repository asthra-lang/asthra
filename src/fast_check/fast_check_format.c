...
char *fast_check_format_result_human(const FileCheckResult *result) {
    ...
    switch (result->status) {
        case FILE_STATUS_OK: status_str = "OK"; break;
        case FILE_STATUS_WARNING: status_str = "WARN"; break;
        case FILE_STATUS_ERROR: status_str = "ERROR"; break;
        case FILE_STATUS_TIMEOUT: status_str = "TIMEOUT"; break;
        case FILE_STATUS_NOT_FOUND: status_str = "NOT_FOUND"; break;
        case FILE_STATUS_PERMISSION: status_str = "PERMISSION"; break;
        case FILE_STATUS_CACHE_ERROR: status_str = "CACHE_ERROR"; break;
...
char *fast_check_format_result_compact(const FileCheckResult *result) {
    ...
    snprintf(buffer, 512, "%s:%d:E%zu:W%zu:%.0fms",
             result->file_path,
             result->status,
             result->error_count,
             result->warning_count,
