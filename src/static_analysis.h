...
ASTHRA_PURE ASTHRA_NONNULL(1) size_t asthra_string_length(const char *restrict str);

ASTHRA_PURE ASTHRA_NONNULL(1, 2) int asthra_string_compare(const char *restrict str1,
...
ASTHRA_NONNULL(1, 2)
char *asthra_string_concatenate(char *restrict dest, const char *restrict src, size_t dest_size,
                                size_t dest_used);

// Const-correct memory operations
ASTHRA_PURE ASTHRA_NONNULL(1, 2) int asthra_memory_compare(const void *restrict ptr1,
                                                           const void *restrict ptr2, size_t size);
...
ASTHRA_PURE ASTHRA_NONNULL(1) size_t asthra_array_length(const void *const *restrict array);

ASTHRA_PURE ASTHRA_NONNULL(1, 3) const
    void *asthra_array_find(const void *const *restrict array, size_t count,
...
ASTHRA_MALLOC ASTHRA_WARN_UNUSED_RESULT void *asthra_alloc_aligned(size_t size, size_t alignment)
    ASTHRA_ASSUME_ALIGNED(16);

ASTHRA_MALLOC ASTHRA_WARN_UNUSED_RESULT void *asthra_alloc_array(size_t element_size, size_t count);

ASTHRA_WARN_UNUSED_RESULT ASTHRA_NONNULL(1) void *asthra_realloc_array(void *restrict ptr,
                                                                       size_t old_count,
                                                                       size_t new_count,
                                                                       size_t element_size);
...
ASTHRA_NONNULL(1, 3)
size_t asthra_buffer_copy(char *restrict dest, size_t dest_size, const char *restrict src,
                          size_t src_size);
...
ASTHRA_PURE ASTHRA_NONNULL(1, 3) bool asthra_buffer_equal(const char *restrict buf1, size_t size1,
                                                          const char *restrict buf2, size_t size2);

// String formatting with restrict annotations
ASTHRA_NONNULL(1, 3)
int asthra_format_string(char *restrict buffer, size_t buffer_size, const char *restrict format,
                         ...);

ASTHRA_NONNULL(1, 3)
int asthra_format_string_va(char *restrict buffer, size_t buffer_size, const char *restrict format,
                            va_list args);
...
ASTHRA_NORETURN ASTHRA_NONNULL(1) void asthra_abort_with_message(const char *restrict message);
