...
AsthraBenchmarkStatus asthra_benchmark_suite_add(AsthraBenchmarkSuite *suite,
    ...
    if (suite->benchmark_count >= suite->capacity) {
        ...
        AsthraBenchmarkDefinition *new_benchmarks =
            realloc(suite->benchmarks, new_capacity * sizeof(AsthraBenchmarkDefinition));
