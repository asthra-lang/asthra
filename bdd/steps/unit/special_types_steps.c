...
void test_never_type(void) {
    const char* source = 
        "package main;\n"
        "\n"
        "pub fn terminate(msg: string) -> Never {\n"
        "    log(msg);\n"
        "    exit(1);\n"
        "}\n"
        "\n"
        "pub fn main(none) -> void {\n"
        "    // Just test that we can declare a Never-returning function\n"
...
void test_never_match(void) {
    const char* source = 
        ...
        "\n"
        "pub fn main(none) -> void {\n"
        "    // Test that Never-returning functions can be defined in context of enums\n"
